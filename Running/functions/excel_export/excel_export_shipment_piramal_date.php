...
$condition = "client_name='PIRAMAL ENTERPRISES LIMITED'";
...
$final_data .= 'S NO' . "\t" . '"ORDER NUMBER"' . "\t" . '"PRODUCT NAME"' . "\t" . '"VEHICLE NO."' . "\t" . '"CONTAINER TYPE"' . "\t" . '"NO. OF DRUMS"' . "\t" . '"GROSS WEIGHT"' . "\t" . '"LR NO."' . "\t" . '"VEHICLE REPORTING DATE & TIME"' . "\t" . '"LOADING DATE"' . "\t" . '"DEPARTURE DATE FROM PORT"' . "\t" . '"FROM"' . "\t" . '"TO"' . "\t" . '"CURRENT STATUS"' . "\t" . '"REPORTING DATE"' . "\t" . '"DELIVERED DATE"' . "\t" . '"VEHICLE RELEASE DATE"' . "\t" . '"DRIVER CONTACT"' . "\t" . '"BILL NO."' . "\t" . '"BILL DT."' . "\t" . '"FREIGHT"' . "\t" . '"DETENTION"' . "\t" . '"OTHER CHARGES"' . "\t" . '"TOTAL BILL AMT"' . "\t" . '"NET WEIGHT"' . "\n";
//$final_data ="";
...
while ($UDB->Multicoloums()) {
    ...
    $final_data .= '"' . $sno . '"' . "\t" . '"' . $order_no . '"' . "\t" . '" "' . "\t" . '"' . $vehicle_no . '"' . "\t" . '"' . $vehicle_type . '"' . "\t" . '"' . $no_of_pack . '"' . "\t" . '" "' . "\t" . '"' . $lr_no . '"' . "\t" . '"' . $landing_date . ' ' . $landing_time . '"' . "\t" . '"' . $loading_end_date . '"' . "\t" . '"' . $dispatch_date . '"' . "\t" . '"' . $orgin . '"' . "\t" . '"' . $destination . '"' . "\t" . '"' . $current_vehicle_status . '"' . "\t" . '"' . $landing_date . '"' . "\t" . '"' . $landing_date . '"' . "\t" . '"' . $vehicle_release_date . ' "' . "\t" . '"' . $driver_contact_no . '"' . "\t" . '"' . $invoice_no . '"' . "\t" . '" "' . "\t" . '" "' . "\t" . '" "' . "\t" . '" "' . "\t" . '" "' . "\t" . '"' . $weight . '"' . "\n";
}
print "$final_data";
?>