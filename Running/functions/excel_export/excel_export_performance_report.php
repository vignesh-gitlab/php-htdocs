...
set_time_limit(0); //to increase maximum execution time
...
$Query = "select order_no,client_name,client_division,client_branch,order_date,order_time,vehicle_required_date,vehicle_required_time,orgin,destination,vehicle_type from sr_customer_order";
$UDB->query($Query);
