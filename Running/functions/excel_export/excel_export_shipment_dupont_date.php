...
$condition = "client_name='E.I.DuPont India Private Limited'";
...
$final_data .= 'S NO' . "\t" . '"ORDER NUMBER"' . "\t" . '"ORDER DATE"' . "\t" . '"ORDER TIME"' . "\t" . '"VEHICLE REQUIRED DATE"' . "\t" . '"VEHICLE REQUIRED TIME"' . "\t" . '"PLACEMENT REQUEST FROM"' . "\t" . '"VEHICLE PLACEMENT DATE"' . "\t" . '"VEHICLE PLACEMENT TIME"' . "\t" . '"DATE OF VEHICLE REACHED AT LOADING POINT"' . "\t" . '"TIME OF VEHICLE REACHED AT LOADING POINT"' . "\t" . '"SBU"' . "\t" . '"CONTRACTUAL /NON CONTRACTUAL"' . "\t" . '"DOUBLE DRIVER (Y/N)"' . "\t" . '"ESCORT (Y/N)"' . "\t" . '"LOADING (Y/N)"' . "\t" . '"UNLOADING (Y/N)"' . "\t" . '"DELIVERY NOTE NO."' . "\t" . '"LOADING DATE"' . "\t" . '"LR NO."' . "\t" . '"LR DT."' . "\t" . '"VEHICLE NO."' . "\t" . '"ORIGIN"' . "\t" . '"DESTINATION"' . "\t" . '"DUPONT INVOICE NO/BE NO."' . "\t" . '"INTERNAL TRANSPORT ORDER NO."' . "\t" . '"NO OF PKG."' . "\t" . '"WT KG"' . "\t" . '"VEHICLE TYPE"' . "\t" . '"CONSIGNEE NAME"' . "\t" . '"E.D.D"' . "\t" . '"A.D.D"' . "\t" . '"ACTUAL NO OF DAYS"' . "\t" . '"AGREED DAYS"' . "\t" . '"HIT/MISS"' . "\t" . '"CURRENT VEHICLE STATUS (INTRANSIT/DELIVERED/ VEHICLE BREAKDOWN)"' . "\t" . '"REMARKS"' . "\t" . '"VEHICLE TRACKING REPORT"' . "\t" . '"ANY DAMAGES REPORTED AT DELIVERY (YES/NO) - IF YES REPORT IN REMARKS COLUMN"' . "\t" . '"DRIVER CONTACT"' . "\n";
//$final_data ="";
...
while ($UDB->Multicoloums()) {
    ...
    $final_data .= '"' . $sno . '"' . "\t" . '"' . $order_no . '"' . "\t" . '"' . $order_date . '"' . "\t" . '"' . $order_time . '"' . "\t" . '"' . $vehicle_required_date . '"' . "\t" . '"' . $vehicle_required_time . '"' . "\t" . '" "' . "\t" . '"' . $placement_date . '"' . "\t" . '"' . $placement_time . '"' . "\t" . '"' . $placement_date . '"' . "\t" . '"' . $placement_time . '"' . "\t" . '"DCP"' . "\t" . '"' . $vehicle_ownership . '"' . "\t" . '"' . $double_driver . '"' . "\t" . '"' . $escart_option . '"' . "\t" . '"' . $loading_charges . '"' . "\t" . '"' . $unloading_charges . '"' . "\t" . '"' . $delivery_note . ' "' . "\t" . '"' . $loading_end_date . '"' . "\t" . '"' . $lr_no . '"' . "\t" . '"' . $lr_date . '"' . "\t" . '"' . $vehicle_no . '"' . "\t" . '"' . $orgin . '"' . "\t" . '"' . $destination . '"' . "\t" . '"' . $invoice_no . '"' . "\t" . '" "' . "\t" . '"' . $no_of_pack . '"' . "\t" . '"' . $weight . '"' . "\t" . '"' . $vehicle_type . '"' . "\t" . '"E.I.DuPont India Private Limited"' . "\t" . '"' . $expected_dateof_delivery . '"' . "\t" . '"' . $landing_date . '"' . "\t" . '"' . $actual_tat . '"' . "\t" . '"' . $agreed_tat . '"' . "\t" . '"' . $hit_miss_status . '"' . "\t" . '"' . $current_vehicle_status . '"' . "\t" . '"' . $delay_reason . '"' . "\t" . '" "' . "\t" . '"' . $damages . '"' . "\t" . '"' . $driver_contact_no . '"' . "\n";
}
print "$final_data";
?>