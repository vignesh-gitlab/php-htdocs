...
$condition = "client_name='Jindal Drugs Limited'";
...
$final_data .= 'S NO' . "\t" . '"ORDER NUMBER"' . "\t" . '"LOADING DATE"' . "\t" . '"DATE OF RELESE"' . "\t" . '"LR NO."' . "\t" . '"LORRY NO."' . "\t" . '"TYPE OF VEHICLE"' . "\t" . '"FROM"' . "\t" . '"TO"' . "\t" . '"INVOICE NUMBER"' . "\t" . '"EDD"' . "\t" . '"REPORTING STATUS"' . "\t" . '"DELIVERED STATUS"' . "\t" . '"HIT/MISS"' . "\t" . '"DRIVER MOBILE NO."' . "\t" . '"ROAMBEE DEVICE NUMBER"' . "\t" . '"REMARKS"' . "\t" . '"POD STATUS."' . "\n";
//$final_data ="";
...
while ($UDB->Multicoloums()) {
    ...
    $final_data .= '"' . $sno . '"' . "\t" . '"' . $order_no . '"' . "\t" . '"' . $loading_end_date . '"' . "\t" . '"' . $dispatch_date . '"' . "\t" . '"' . $lr_no . '"' . "\t" . '"' . $vehicle_no . '"' . "\t" . '"' . $vehicle_type . '"' . "\t" . '"' . $orgin . '"' . "\t" . '"' . $destination . '"' . "\t" . '"' . $invoice_no . '"' . "\t" . '"' . $expected_dateof_delivery . '"' . "\t" . '"' . $landing_date . '"' . "\t" . '"' . $landing_date . '"' . "\t" . '"' . $hit_miss_status . '"' . "\t" . '"' . $driver_contact_no . '"' . "\t" . '" "' . "\t" . '"' . $delay_reason . ' "' . "\t" . '" "' . "\n";
}
print "$final_data";
?>