...
$condition = "client_name='Bayer Material Science Private Limited'";
...
$final_data .= 'S NO' . "\t" . '"ORDER NUMBER"' . "\t" . '"LR NO"' . "\t" . '"INVOICE NO."' . "\t" . '"ROAD PERMIT NO."' . "\t" . '"SHIPMENT UNIT NO.(SU NO.)"' . "\t" . '"DATE 0F  LOADING"' . "\t" . '"NOS OF DRUMS/BAGS"' . "\t" . '"TOTAL WT DURING LOADING (NET)"' . "\t" . '"CHARGED  WEIGHT GROSS"' . "\t" . '"TYPE OF VEHICLE"' . "\t" . '"VEHICLE NO."' . "\t" . '"FROM (LOCATION)"' . "\t" . '"TO (LOCATION)"' . "\t" . '"CUSTOMER NAME"' . "\t" . '"BILL AMOUNT"' . "\t" . '"NO. OF VEHICLES REJECTED (0,1,2 ETC.)"' . "\t" . '"INCIDENT IN TRANSIT"' . "\t" . '"ORDER PLACEMENT DATE"' . "\t" . '"VEHICLE ARRIVAL DATE"' . "\t" . '"VEHICLE DEPARTURE DATE"' . "\t" . '"REPORTING DATE"' . "\t" . '"DELIVERY DATE"' . "\t" . '"AGREED TRANSIT DAYS"' . "\t" . '"ACTUAL TRANSIT DAYS"' . "\t" . '"CURRENT STATUS OF VEHICLE"' . "\t" . '"REMARK"' . "\t" . '"DRIVER CONTACT"' . "\t" . '"ORDER RECD DATE FROM CUSTOMER"' . "\t" . '"ORDER RECD TIME FROM CUSTOMER"' . "\t" . '"VEHICLE REQUIRED DATE"' . "\t" . '"VEHICLE REQUIRED TIME"' . "\t" . '"DATE OF VEHICLE REACHED AT LOADING POINT"' . "\t" . '"TIME OF VEHICLE REACHED AT LOADING POINT"' . "\n";
//$final_data ="";
...
while ($UDB->Multicoloums()) {
    ...
    $final_data .= '"' . $sno . '"' . "\t" . '"' . $order_no . '"' . "\t" . '"' . $lr_no . '"' . "\t" . '"' . $invoice_no . '"' . "\t" . '" "' . "\t" . '" "' . "\t" . '"' . $loading_end_date . '"' . "\t" . '"' . $no_of_pack . '"' . "\t" . '"' . $weight . '"' . "\t" . '" "' . "\t" . '"' . $vehicle_type . '"' . "\t" . '"' . $vehicle_no . '"' . "\t" . '"' . $orgin . '"' . "\t" . '"' . $destination . '"' . "\t" . '"Bayer Material Science Private Limited"' . "\t" . '" "' . "\t" . '" "' . "\t" . '" "' . "\t" . '"' . $order_date . '"' . "\t" . '"' . $placement_date . '"' . "\t" . '"' . $dispatch_date . '"' . "\t" . '"' . $expected_dateof_delivery . '"' . "\t" . '"' . $landing_date . '"' . "\t" . '"' . $agreed_tat . '"' . "\t" . '"' . $actual_tat . '"' . "\t" . '"' . $current_vehicle_status . '"' . "\t" . '"' . $delay_reason . '"' . "\t" . '"' . $driver_contact_no . '"' . "\t" . '"' . $order_date . '"' . "\t" . '"' . $order_time . '"' . "\t" . '"' . $vehicle_required_date . '"' . "\t" . '"' . $vehicle_required_time . '"' . "\t" . '"' . $placement_date . '"' . "\t" . '"' . $placement_time . '"' . "\n";
}
print "$final_data";
?>