...
$actionpage = 'contractor_action.php';
...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="contractor_grid.php">Contractor</a></li>
                                ...
                                <table cellspacing="0">
                                    <tr>
                                        <td  class="form_label_split2">
                                            <span class="red">*&nbsp;</span>Contractor Name
                                        </td>
                                        <td class="form_content_split2" align="center">
                                            <input type="text" required name="contractor_name" class="form-control" value="<?php if ($id_error == false) echo $contractor_name; ?>">
                                        </td>
