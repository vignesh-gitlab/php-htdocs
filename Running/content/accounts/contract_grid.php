...
$child_page = 'contract_child_grid.php';
$action_page = 'contract_action.php';
$tablename = 'sr_contract';
$return_page = '../accounts/contract_grid.php';
?>
                                ...
                                while ($DB->Multicoloums()) {
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="<?php echo $child_page . "?contract_no=" . $DB->Record["contract_no"]; ?>" title="View"><i class="fa fa-fw fa-indent"></i></a>
