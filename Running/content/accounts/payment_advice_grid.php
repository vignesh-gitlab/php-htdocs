...
$action_page = 'payment_advice_action.php';
$tablename = 'sr_payment_advice';
$return_page = '../accounts/money_receipt_grid.php';
                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,client_name,document_no,cheque_no,cheque_date,bank_name,cheque_amount,pa_status from $tablename";
                                $UDB->query($Query);
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li class="user-footer">
                                                            <div style="text-align:center;">
                                                                ...
                                                                <a href="<?php echo $action_page; ?>?order_no=<?php echo $UDB->Record["document_no"] ?>&form_action=Delete" id="delete_button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa fa-check"></i> Yes</a>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                </li>
