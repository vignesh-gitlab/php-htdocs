...
$return_page = '../accounts/vehicle_placement_closed_opertion_grid.php';
...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Select Bilty Order</li>
        </ol>
    </section>
    <!-- Main content -->
