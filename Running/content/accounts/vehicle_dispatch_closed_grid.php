...
$return_page = '../accounts/vehicle_dispatch_grid.php';
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                while ($UDB->Multicoloums()) {
                                    ?>
                                    <tr>
                                        <td><a href="<?php echo $bilty_page . "?lr_no=" . $UDB->Record["lr_no"]; ?>" title="Add Bilty"><i class="fa fa-fw fa-plus-circle"></i></a></td>
