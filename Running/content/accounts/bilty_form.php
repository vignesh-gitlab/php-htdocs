...
$consignment_error = false;
if ((!isset($_REQUEST["lr_no"])) || (empty($_REQUEST["lr_no"]))) {
    $consignment_error = true;
}
?>
<?php
if ($consignment_error == false) {
    $Query = "SELECT  id,order_no,so_no,orgin,destination,invoice_no,lr_no,lr_date,vehicle_no,container_no from sr_vehicle_dispatch where lr_no='" . $_REQUEST["lr_no"] . "'";
    $UDB->query($Query);
    while ($UDB->Multicoloums()) {
        ...
        $consignor_invoice_no = $UDB->Record["invoice_no"];
        $consignment_note_no = $UDB->Record["lr_no"];
        $consignment_date = $UDB->Record["lr_date"];
        $vehicle_no = $UDB->Record["vehicle_no"];
        $container_no = $UDB->Record["container_no"];
    }
    $Query = "SELECT  id,order_no,so_no,so_date,order_date from sr_customer_order where order_no='" . $order_no . "'";
    $UDB->query($Query);
    while ($UDB->Multicoloums()) {
        $so_no = $UDB->Record["so_no"];
...
if ($id_error == false) {
    ...
    while ($UDB->Multicoloums()) {
        ...
        $fov = $UDB->Record["fov"];
        $octroi_charges = $UDB->Record["octroi_charges"];
...
<script type="text/javascript">
    ...
    function AjaxFunction_client_details(consignee_account_no)
    {
        if (consignee_account_no == "Bank")
        {
            for (j = document.form.consignee_account_name.options.length - 1; j >= 0; j--)
            {
                document.form.consignee_account_name.remove(j);
            }
            /*document.getElementById("consignee_account_name").value = "";
             document.getElementById("consignee_account_name").disabled = true;
             document.form.consignor_tin_no.value = " ";*/
            var optn = document.createElement("OPTION");
            optn.text = "Select";
            optn.value = "Select";
            document.form.consignee_account_name.options.add(optn);

            document.form.consignee_bank.value = "";
            document.getElementById("consignee_bank").readOnly = false;
        } else
        {
            document.getElementById("consignee_account_name").disabled = false;
            var httpxml;
            try
            {
                // Firefox, Opera 8.0+, Safari
            ...
            var url = "bilty_dependent1.php";
            url = url + "?client_location=" + consignee_account_no;
    ...
    {
        document.form.consignee_bank.value = client_value;
    }

    function AjaxFunction_client_value_text()
    {
        var client_value = document.getElementById('consignee_bank').value;
        document.form.consignee_bank.value = client_value;
    }
    ...
    function calculate_total()
    {
        ...
        octroi = Number(document.getElementById('octroi_charges').value);
        var total = 0;
        total = Number(total_frieght) + Number(hamall) + Number(sur_charges) + Number(st_charges) + Number(risk_charges) + Number(checkpost) + Number(fov) + Number(octroi);
                                ...
                                <table cellspacing="0">
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <input type="text" name="order_no" class="form-control" readonly value="<?php if ($id_error == false || $orderno_error == false || $consignment_error == false) echo $order_no; ?>">
                                        </td>
                                        <td  class="form_label_split2">
                                            Order Date
                                        </td>
                                        <td class="form_content_split2" align="center">
                                            <input type="text" name="order_date" class="form-control" readonly value="<?php if ($id_error == false || $orderno_error == false || $consignment_error == false) echo $order_date; ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td  class="form_label_split2">
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <input type="text" name="so_no" class="form-control" readonly value="<?php if ($id_error == false || $orderno_error == false || $consignment_error == false) echo $so_no; ?>">
                                        </td>
                                        <td  class="form_label_split2">
                                            Sales Order Date
                                        </td>
                                        <td class="form_content_split2" align="center">
                                            <input type="text" name="so_date" class="form-control" readonly value="<?php if ($id_error == false || $orderno_error == false || $consignment_error == false) echo $so_date; ?>">
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div class="form_tablebox">
                                <table cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            ...
                                            /* $Query = "SELECT max(cast(consignment_note_no as unsigned))as max_id from $tablename";
                                              ...
                                              $new_max_id = $max_id + 1;
                                             */
                                            if ($id_error == false || $consignment_error == false) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <input type="text" readonly name="lane_from" class="form-control" value="<?php if ($id_error == false || $orderno_error == false || $consignment_error == false) echo $lane_from; ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="form_content_split2" align="center">
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <input type="text" readonly name="lane_to" class="form-control" value="<?php if ($id_error == false || $orderno_error == false || $consignment_error == false) echo $lane_to; ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td  class="form_label_split2">
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <select class="form-control dropdown_padding" id="consignee_account_no" name="consignee_account_no" onchange="AjaxFunction_client_details(this.value)">
                                                <option>Select</option>
                                                <?php
                                                $Query = "select consignee_type from  master_consignee order by id";
                                                $DB->query($Query);

                                                while ($DB->Multicoloums()) {
                                                    echo'<option>' . $DB->Record["consignee_type"] . '</option>';
                                                }
                                                ?>
                                            </select>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <input type="text" name="consignor_invoice_no" class="form-control" value="<?php if ($id_error == false || $consignment_error == false) echo $consignor_invoice_no; ?>" placeholder="Invoice Number">
                                        </td>
                                        <td class="form_content_split2" align="center">
                                            <select class="form-control dropdown_padding" id="consignee_account_name" name="consignee_account_name" onchange="AjaxFunction_client_value(this.value)">
                                                <option>Select</option>
                                                <?php
                                                ...
                                                while ($DB->Multicoloums()) {
                                                    if ($id_error == false && $consignee_account_name == $DB->Record["client_name"]) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <input type="text" name="consignor_tin_no" id="consignor_tin_no" class="form-control" value="<?php if ($id_error == false) echo $consignor_tin_no; ?>"  placeholder="TIN Number">
                                        </td>
                                        <td class="form_content_split2" align="center">
                                            <input type="text" name="consignee_bank" id="consignee_bank" class="form-control" onblur="AjaxFunction_client_value_text();" value="<?php if ($id_error == false) echo $consignee_bank; ?>" readonly="true"readonly="true">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td  class="form_label_split2">
                                        ...
                                        <td class="form_label_split2" align="center" colspan="2">
                                          <!--  <input type="text" name="consignee_branch" class="form-control" value="<?php if ($id_error == false) echo $consignee_branch; ?>" >-->
                                        </td>
                                    </tr>
                                </table>
                            </div>
                                ...
                                <table cellspacing="0">
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="left">
                                            <select class="form-control dropdown_padding" id="bill_party" name="bill_party">
                                                <option>Select</option>
                                                <?php
                                                $Query = "select distinct(client_name) from sr_client order by client_name";
                                                $DB->query($Query);
                                                ...
                                                while ($DB->Multicoloums()) {
                                                    if ($id_error == false && $bill_party == $DB->Record["client_name"]) {
                                                        echo'<option selected>' . $DB->Record["client_name"] . '</option>';
                                                    } else {
                                                        echo'<option>' . $DB->Record["client_name"] . '</option>';
                                                    }
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <input type="text" name="vehicle_no" class="form-control" value="<?php if ($id_error == false || $orderno_error == false || $consignment_error == false) echo $vehicle_no; ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="form_content_split2" align="center">
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <input type="text" name="container_no" class="form-control" value="<?php if ($id_error == false || $consignment_error == false) echo $container_no; ?>">
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div class="form_tablebox">
                                <table cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_content_multiple" align="center">
                                            <input type="text" name="octroi_charges" id="octroi_charges" onblur="calculate_total()" style="text-align: right;" class="form-control" value="<?php
                                            if ($id_error == false) {
                                                echo $octroi_charges;
                                            } else {
                                                echo "0.00";
