...
if ($id_error == false) {
    $Query = "SELECT  id,company_name,company_caption,address_line1,address_line2,city,pincode,telephone_no,mobile_no,fax_no,email_id,website_id,tin_no,cst_no from $tablename where id='" . $_REQUEST["id"] . "'";
    $DB->query($Query);
...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="company_grid.php">Corporate Office</a></li>
                                ...
                                <table cellspacing="0">
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <input type="text" required name="company_name" class="form-control" value="<?php if ($id_error == false) echo $company_name; ?>">
                                        </td>
                                        <td  class="form_label_split2">
                                            Company Caption
                                        </td>
                                        <td class="form_content_split2" align="center">
                                            <input type="text" name="company_caption" class="form-control" value="<?php if ($id_error == false) echo $company_caption; ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <input type="text" name="website_id" class="form-control" value="<?php if ($id_error == false) echo $website_id; ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td  class="form_label_split2">
