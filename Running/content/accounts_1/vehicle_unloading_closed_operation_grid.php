...
$return_page = '../accounts/vehicle_unloading_closed_operation_grid.php';
...
<aside class="right-side strech">
    ...
    <section class="content-header">
        <h1>
            Select Lorry Arrival Report Order
        </h1>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Select Lorry Arrival Report Order</li>
        </ol>
    </section>
    <!-- Main content -->
                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,order_no,client_name,client_division,client_branch,orgin,destination,vehicle_type,vehicle_no,dispatch_date,dispatch_time,landing_date,landing_time,unloading_date,unloading_time,action_user from $tablename where lar_status<>'2' order by order_no";
                                $UDB->query($Query);
