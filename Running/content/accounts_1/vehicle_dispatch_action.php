...
$grid_page = 'vehicle_dispatch_grid.php';
...
';
    ...
    $Query = "update $tablename set dispatch_date='" . $_REQUEST["dispatch_date"] . "',dispatch_time='" . $_REQUEST["dispatch_time"] . "',no_of_pack='" . $_REQUEST["no_of_pack"] . "',weight='" . $_REQUEST["weight"] . "',lr_no='" . $_REQUEST["lr_no"] . "',lr_date='" . $_REQUEST["lr_date"] . "',consignee_name='" . $_REQUEST["consignee_name"] . "',invoice_no='" . $_REQUEST["invoice_no"] . "',btn='" . $_REQUEST["btn"] . "',delivery_note='" . $_REQUEST["delivery_note"] . "',expected_dateof_delivery='" . $_REQUEST["expected_dateof_delivery"] . "' where id=" . $_REQUEST["id"];
    $UDB->query($Query);
