...
$actionpage = 'service_product_action.php';
...
if ($id_error == false) {
    $Query = "SELECT id,service_product from $tablename where id='" . $_REQUEST["id"] . "'";
    $DB->query($Query);
    while ($DB->Multicoloums()) {
        $service_product = $DB->Record["service_product"];
    }
}
?>
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="service_product_grid.php">Vehicle Category</a></li>
                                ...
                                <table cellspacing="0">
                                    <tr>
                                        <td  class="form_label_split2">
                                            <span class="red">*&nbsp;</span>Vehicle Category
                                        </td>
                                        <td class="form_content_split2" align="center">
                                            <input type="text" required name="service_product" class="form-control" value="<?php if ($id_error == false) echo $service_product; ?>">
                                        </td>
                                    </tr>
                                </table>
                            </div>
