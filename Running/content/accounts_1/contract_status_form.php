...
$actionpage = 'contract_status_action.php';
...
if ($id_error == false) {
    $Query = "SELECT id,contract_status from $tablename where id='" . $_REQUEST["id"] . "'";
    $DB->query($Query);
    while ($DB->Multicoloums()) {
        $contract_status = $DB->Record["contract_status"];
    }
}
?>
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="contract_status_grid.php">Vehicle Contract Status</a></li>
                                ...
                                <table cellspacing="0">
                                    <tr>
                                        <td  class="form_label_split2">
                                            <span class="red">*&nbsp;</span>Contract Status
                                        </td>
                                        <td class="form_content_split2" align="center">
                                            <input type="text" required name="contract_status" class="form-control" value="<?php if ($id_error == false) echo $contract_status; ?>">
                                        </td>
                                    </tr>
                                </table>
                            </div>
