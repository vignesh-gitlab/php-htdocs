...
$actionpage = 'bank_account_type_action.php';
...
if ($id_error == false) {
    $Query = "SELECT id,account_type from $tablename where id='" . $_REQUEST["id"] . "'";
    $DB->query($Query);
    while ($DB->Multicoloums()) {
        $account_type = $DB->Record["account_type"];
    }
}
?>
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="bank_account_type_grid.php">Account Type</a></li>
                                ...
                                <table cellspacing="0">
                                    <tr>
                                        <td  class="form_label_split2">
                                            <span class="red">*&nbsp;</span>Account Type
                                        </td>
                                        <td class="form_content_split2" align="center">
                                            <input type="text" required name="account_type" class="form-control" value="<?php if ($id_error == false) echo $account_type; ?>" autofocus>
                                        </td>
                                    </tr>
                                </table>
                            </div>
