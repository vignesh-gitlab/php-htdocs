...
<?php
$form_page = 'type_of_movement_form.php';
$tablename = 'master_type_of_movement';
$return_page = '../superadmin/type_of_movement_grid.php';
?>
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Type Of Movement</li>
        </ol>
    </section>
    <!-- Main content -->
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,type_of_movement from $tablename order by type_of_movement";
                                $DB->query($Query);
