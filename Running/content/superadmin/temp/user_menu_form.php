...
if ($id_error == false) {
    ...
    $Query1 = "SELECT id,usertype,username,menu_name,page_name from $tablename where username= '" . $username . "'";
    $DB1->query($Query1);
    while ($DB1->Multicoloums()) {
        $usertype = $DB1->Record["usertype"];
        $username = $DB1->Record["username"];
        $menu_name = $DB1->Record["menu_name"];
                                                        ...
                                                        <div class="box box-solid">
                                                            ...
                                                            <div class="box-body" style='margin-top:-15px;'>
                                                                ...
                                                                while ($DB1->Multicoloums()) {
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" name="<?php echo $check_pagename ?>" value='<?php echo $page_name ?>'>&nbsp;&nbsp;&nbsp;<strong><?php echo $page_name ?></strong><br>
                                                                    <?php
                                                                }
                                                                ?>
