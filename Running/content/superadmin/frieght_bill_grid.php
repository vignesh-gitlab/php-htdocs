...
$return_page = '../superadmin/frieght_bill_grid.php';
...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Frieght Bill</li>
        </ol>
    </section>
    <!-- Main content -->
                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,branch,client_name,service_tax_payable_by,bill_no,bill_date,frieght_status from $tablename where frieght_status<>'Approval' and frieght_status<>'Close'";
                                $UDB->query($Query);
                                while ($UDB->Multicoloums()) {
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="<?php echo $form_page . "?bill_no=" . $UDB->Record["bill_no"]; ?>&form_action1=date_of_receiving" title="Update Receiving Date"><i class="fa fa-fw fa-thumbs-up"></i></a>
