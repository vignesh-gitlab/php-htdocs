...
$actionpage = 'vendor_category_action.php';
...
if ($id_error == false) {
    $Query = "SELECT id,vendor_category from $tablename where id='" . $_REQUEST["id"] . "'";
    $DB->query($Query);
...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="vendor_category_grid.php">Vendor Category</a></li>
                                ...
                                <table cellspacing="0">
                                    <tr>
                                        <td  class="form_label_split2">
                                            <span class="red">*&nbsp;</span>Vendor Category
                                        </td>
                                        <td class="form_content_split2" align="center">
                                            <input type="text" required name="vendor_category" class="form-control" value="<?php if ($id_error == false) echo $vendor_category; ?>" autofocus>
                                        </td>
                                    </tr>
                                </table>
                            </div>
