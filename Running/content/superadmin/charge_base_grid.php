...
<?php
$form_page = 'charge_base_form.php';
$tablename = 'master_charge_base';
$return_page = '../superadmin/charge_base_grid.php';
?>
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Charge Base</li>
        </ol>
    </section>
    <!-- Main content -->
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,charge_base from $tablename order by charge_base";
                                $DB->query($Query);
