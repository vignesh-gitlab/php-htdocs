...
$actionpage = 'vehicle_type_action.php';
...
if ($id_error == false) {
    $Query = "SELECT id,vehicle_type from $tablename where id='" . $_REQUEST["id"] . "'";
    $DB->query($Query);
...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="vehicle_type_grid.php">Vehicle Type</a></li>
                                ...
                                <table cellspacing="0">
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <input type="text" required name="vehicle_type" class="form-control" value="<?php if ($id_error == false) echo $vehicle_type; ?>">
                                        </td>
                                    </tr>
                                </table>
                            </div>
