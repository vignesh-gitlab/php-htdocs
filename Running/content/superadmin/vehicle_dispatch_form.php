...
$actionpage = 'vehicle_dispatch_action.php';
...
if ($orderno_error == false) {
    ...
    $Query = "SELECT total_packages,rate_per_kg,lorry_chellan_no,lorry_chellan_date from sr_lorry_chellan where order_no='" . $_REQUEST["order_no"] . "'";
    $UDB->query($Query);
    while ($UDB->Multicoloums()) {
        $no_of_pack = $UDB->Record["total_packages"];
        $weight = $UDB->Record["rate_per_kg"];
        $lr_no = $UDB->Record["lorry_chellan_no"];
        $lr_date = $UDB->Record["lorry_chellan_date"];
    }
    $Query = "SELECT consignor_name from sr_bilty where order_no='" . $_REQUEST["order_no"] . "'";
    $UDB->query($Query);
    while ($UDB->Multicoloums()) {
        $consignee_name = $UDB->Record["consignor_name"];
    }
}
...
if ($id_error == false) {
    $Query = "SELECT  id,order_no,so_no,client_name,client_division,client_branch,orgin,destination,vehicle_type,vehicle_no,placement_date,placement_time,loading_start_date,loading_start_time,loading_end_date,loading_end_time,dispatch_date,dispatch_time,no_of_pack,weight,lr_no,lr_date,consignee_name,invoice_no,btn,delivery_note,expected_dateof_delivery,container_no from $tablename where id='" . $_REQUEST["id"] . "'";
    $UDB->query($Query);
    while ($UDB->Multicoloums()) {
        $order_no = $UDB->Record["order_no"];
        $so_no = $UDB->Record["so_no"];
                            ...
                            <div class="form_tablebox">
                                <table cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <input type="text" name="no_of_pack" class="form-control" value="<?php if ($id_error == false || $orderno_error == false) echo $no_of_pack; ?>">
                                        </td>
                                        <td  class="form_label_split2">
                                            Weight
                                        </td>
                                        <td class="form_content_split2" align="center">
                                            <input type="text" name="weight" class="form-control" value="<?php if ($id_error == false || $orderno_error == false) echo $weight; ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td  class="form_label_split2">
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <input type="text" required name="lr_no" class="form-control" value="<?php if ($id_error == false || $orderno_error == false) echo $lr_no; ?>">
                                        </td>
                                        <td  class="form_label_split2">
                                            LR Date
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <input type="text" name="consignee_name" class="form-control" value="<?php if ($id_error == false || $orderno_error == false) echo $consignee_name; ?>">
                                        </td>
                                        <td  class="form_label_split2">
                                    ...
                                    <tr>
                                        ...
                                        <td  class="form_label_split2">
                                            <span class="red">*&nbsp;</span>Delivery Note / BOE Number
                                        </td>
                                        <td class="form_content_split2" align="center">
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <input type="text" required name="container_no" class="form-control" value="<?php if ($id_error == false) echo $container_no; ?>">
                                        </td>
                                    </tr>
                                </table>
                            </div>
                                ...
                                <div class="form_tablebox">
                                    <table cellspacing="0">
                                        <tr>
                                            ...
                                            <td class="form_content_split2" align="center">
                                                <input type="file" name="lr_copy" class="form-control" style="padding:0px;">
                                            </td>
                                            <td  class="form_label_split2">
                                                Invoice Copy Upload
                                            </td>
                                            <td class="form_content_split2" align="center">
                                                <input type="file" name="invoice_copy" class="form-control" style="padding:0px;">
                                            </td>
                                        </tr>
                                    </table>
                                </div>
