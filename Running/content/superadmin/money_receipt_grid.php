...
$print_page = 'money_receipt_print.php';
...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Bill Money Receipt</li>
        </ol>
    </section>
    <!-- Main content -->
                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,order_no,client_name,branch,bmr_no,bmr_date,mr_date,mr_status from $tablename where mr_status<>'Approval' and mr_status<>'Close'";
                                $UDB->query($Query);
                                while ($UDB->Multicoloums()) {
                                    ...
                                    <tr>
                                        <td>
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li class="user-footer">
                                                            <div style="text-align:center;">
                                                                ...
                                                                <a href="<?php echo $action_page; ?>?bmr_no=<?php echo $UDB->Record["bmr_no"] ?>&form_action=Delete" id="delete_button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa fa-check"></i> Yes</a>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                </li>
                                            ...
                                            <a href="<?php echo $form_page . "?order_no=" . $UDB->Record["id"] . "&approval=Approve" . "&id=" . $UDB->Record["id"]; ?>" title="Approve"><i class="fa fa-fw fa-check"></i></a>
                                        </td>
