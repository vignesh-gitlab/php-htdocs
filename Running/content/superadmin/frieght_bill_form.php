...
<?php
if ($id_error == false) {
    $Query = "SELECT id,branch_code,branch,stationary_no,client_name,division_name,branch_name,service_tax_payable_by,party_address_line1,party_address_line2,party_city,party_pincode,bill_no,bill_date,credit_days,pan_no,total from $tablename where id='" . $_REQUEST["id"] . "'";
    $UDB->query($Query);
...
} elseif ($receiving_error == false) {
    $Query = "SELECT id,branch_code,branch,stationary_no,client_name,division_name,branch_name,service_tax_payable_by,party_address_line1,party_address_line2,party_city,party_pincode,bill_no,bill_date,credit_days,pan_no,total from $tablename where bill_no='" . $_REQUEST["bill_no"] . "'";
    $UDB->query($Query);
    while ($UDB->Multicoloums()) {
        $branch_code = $UDB->Record["branch_code"];
        $branch = $UDB->Record["branch"];
    ...
    $Query = "SELECT id,date_of_receiving from sr_date_of_receiving where bill_no='" . $bill_no . "'";
    $UDB->query($Query);
    while ($UDB->Multicoloums()) {
        $date_of_receiving = $UDB->Record["date_of_receiving"];
    }
    /* $edit_product_count = 0;
      $Query = "SELECT id,bill_date_item,no_item,particular,from_to,weight,rate,rate_type,sub_total from $tablename1 where bill_no='" . $bill_no . "'";
      $UDB->query($Query);
            ...
            <div class="col-xs-12">
                <form role="form" name="form" id="form1" method="post" onsubmit="return checkForm(this);" action="<?php echo $actionpage; ?>" enctype="multipart/form-data" autocomplete="<?php echo AUTOCOMPLETE ?>">
                            ...
                            <div class="form_tablebox">
                                <table cellspacing="0">
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <select class="form-control dropdown_padding" name="branch_code" id="branch_code" onchange="AjaxFunction_display_branch(this.value)">
                                                ...
                                                while ($DB->Multicoloums()) {
                                                    if ($id_error == false || $receiving_error == false && $branch_code == $DB->Record["branch_code"]) {
                                        ...
                                        <td class="form_content_split2" align="left">
                                            <select class=" form-control dropdown_padding" name="client_name" id="client_name" onchange="AjaxFunction_display_division_name(this.value)">
                                                ...
                                                while ($DB->Multicoloums()) {
                                                    if ($id_error == false || $receiving_error == false && $client_name == $DB->Record["client_name"]) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <input type="text" required name="branch" id="branch" autofocus class="form-control" value="<?php if ($id_error == false || $receiving_error == false) echo $branch; ?>">
                                        </td>
                                        <td  class="form_label_split2">
                                            Division Name
                                        </td>
                                        <td class="form_content_split2" align="center">
                                            <select class="form-control dropdown_padding" name="division_name" id="division_name" onchange="AjaxFunction_display_branch_name(this.value)">
                                                ...
                                                while ($DB->Multicoloums()) {
                                                    if ($id_error == false || $receiving_error == false && $division_name == $DB->Record["division_name"]) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <input type="text" required name="stationary_no" id="stationary_no"  class="form-control" onblur="check_bilty_no()" value="<?php if ($id_error == false || $receiving_error == false) echo $stationary_no; ?>">
                                        </td>
                                        <td  class="form_label_split2">
                                            Branch Name
                                        </td>
                                        <td class="form_content_split2" align="center">
                                            <select class="form-control dropdown_padding" name="branch_name" id="branch_name" onchange="AjaxFunction_display_client_details(this.value)">
                                                ...
                                                while ($DB->Multicoloums()) {
                                                    if ($id_error == false || $receiving_error == false && $branch_name == $DB->Record["branch_name"]) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <select class="form-control dropdown_padding" name="service_tax_payable_by">
                                                ...
                                                while ($DB->Multicoloums()) {
                                                    if ($id_error == false || $receiving_error == false && $service_tax_payable_by == $DB->Record["service_tax_payable_by"]) {
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <input type="text" name="party_address_line1" id="party_address_line1" class="form-control" value="<?php if ($id_error == false || $receiving_error == false) echo $party_address_line1; ?>" placeholder="Address Line1">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <input type="text" required name="bill_no" id="bill_no" class="form-control" value="<?php if ($id_error == false || $receiving_error == false) echo $bill_no; ?>">
                                        </td>

                                        <td class="form_content_split2" align="center">
                                            <input type="text" name="party_address_line2" id="party_address_line2" class="form-control" value="<?php if ($id_error == false || $receiving_error == false) echo $party_address_line2; ?>" placeholder="Address Line2">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <div class="input-group">
                                                ...
                                                if ($id_error == false || $receiving_error == false) {
                                                    echo $bill_date;
                                                } else {
                                                    echo date('d-m-Y');
                                                }
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <input type="text" name="party_city" id="party_city" class="form-control" value="<?php if ($id_error == false || $receiving_error == false) echo $party_city; ?>" placeholder="City" style="float:left; width:70%;">
                                            <input type="text" name="party_pincode" id="party_pincode" class="form-control" value="<?php if ($id_error == false || $receiving_error == false) echo $party_pincode; ?>" placeholder="Pincode" style="float:left; width:30%;">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td  class="form_label_split2">
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <input type="text" name="credit_days" class="form-control" value="<?php if ($id_error == false || $receiving_error == false) echo $credit_days; ?>">
                                        </td>
                                        <td  class="form_label_split2">
                                            PAN No.
                                        </td>
                                        <td class="form_content_split2" align="center">
                                            <input type="text" name="pan_no" class="form-control" value="<?php if ($id_error == false || $receiving_error == false) echo $pan_no; ?>">
                                        </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="form_content_multiple">
                                                <select class="form-control dropdown_padding" name="no_item<?php echo $i; ?>" id="no_item<?php echo $i; ?>"  onchange="AjaxFunction_display_from_to(this.value,<?php echo $i; ?>)">
                                                    <option>Select</option>
                                                    <?php
                                                    if ($id_error == false || $receiving_error == false && $no_item_array[$i - 1] != NULL) {
                                            ...
                                            <td class="form_content_multiple">
                                                <input type="text" name="from_to<?php echo $i; ?>" id="from_to<?php echo $i; ?>" class="form-control" value="<?php if ($id_error == false || $receiving_error == false) echo $from_to_array[$i - 1]; ?>">
                                            </td>
                                            <td class="form_content_multiple">
                                            ...
                                            <td class="form_content_multiple" align="center">
                                                <select class="form-control dropdown_padding" onchange="calculate_amount(<?php echo $i; ?>)" id="rate_type<?php echo $i; ?>" name="rate_type<?php echo $i; ?>">
                                                    ...
                                                    while ($DB->Multicoloums()) {
                                                        if ($id_error == false || $receiving_error == false && $rate_type_array[$i - 1] == $DB->Record["rate_type"]) {
                                ...
                                <div class="form_tablebox">
                                    <table cellspacing="0">
                                        <tr>
                                            ...
                                            <td class="form_content_split2" align="center">
                                                <div class="input-group">
                                                    <input type="text" readonly="true" name="date_of_receiving" class="form-control pull-right" id="date_of_receiving" onfocus="pick_date(this.id);" value="<?php
                                                    if ($id_error == false || $receiving_error == false) {
                                                        echo $date_of_receiving;
                                                    } else {
                                                        echo date('d-m-Y');
                                                    }
                                                    ?>">
                    ...
                    <div class="box-footer">
                        ...
                        } else if ($receiving_error == false) {
                            echo'<input type="hidden" name="form_action1" value="date_of_receiving"/>';
