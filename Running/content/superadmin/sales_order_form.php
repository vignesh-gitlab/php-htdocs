...
<script type="text/javascript">
    ...
    {
        var quotation_ref_no = document.getElementById('quotation_ref_no').value;
        ...
        var url = "sales_order_dependent4.php";
        url = url + "?quotation_ref_no=" + quotation_ref_no + "&lane_id=" + lane_id + "&line_total=" + line_total;
        //url=url+"&sid="+Math.random();
        httpxml.onreadystatechange = stateck;
        httpxml.open("GET", url, true);
        httpxml.send(null);
...
<?php
if ($wono_error == false) {
    $Query = "SELECT quotation_no,quotation_date,vehicle_type,vehicle_required_date,tax_category,client_name,division_name,branch_name,address_line1,address_line2,city,pincode,contact_no,tax_category,terms_and_condition,sub_total,total_tax,discount, grand_total from sr_quotation where quotation_no='" . $_REQUEST["quotation_no"] . "'";
    $UDB->query($Query);
    while ($UDB->Multicoloums()) {
        $quotation_ref_no = $UDB->Record["quotation_no"];
    ...
    $Query = "SELECT  lane_id,lane_from,lane_to,unit_price,ex_total,tax_rate,tax_type,tax_total,amount from sr_quotation_item where quotation_no='" . $quotation_ref_no . "'";
                            ...
                            <div class = "form_tablebox">
                                <table cellspacing = "0">
                                    ...
                                    <tr>
                                        ...
                                        <td class = "form_label_split2">
                                            <input type = "text" readonly name = "quotation_ref_no" id="quotation_ref_no" class = "form-control" value = "<?php if (($id_error == false ) || ( $wono_error == false )) echo $quotation_ref_no; ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td  class="form_label_split2">
                                ...
                                <table cellspacing="0">
                                    ...
                                    for ($i = 1; $i <= 25; $i++) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="form_content_multiple">
                                                <input type="text" style="text-align:right;" readonly id="amount<?php echo $i; ?>"  name="amount<?php echo $i; ?>" class="form-control" onblur="AjaxFunction_validate_remarks(this.value, <?php echo $i; ?>)" value="<?php
                                                if (($id_error == false ) || ( $wono_error == false )) {
                                            ...
                                            <td class="form_content_multiple">
                                                <input type="text" style="text-align:right;"  id="remarks<?php echo $i; ?>"  name="remarks<?php echo $i; ?>" class="form-control" value="<?php
                                                if (($id_error == false ) || ( $wono_error == false )) {
                                    ...
                                    ?>
                                    <tr>
                                        <td colspan="4" class="form_label_multiple">Terms & Condition</td>
                                    ...
                                    <tr>
                                        <td colspan="4" rowspan="3" class="form_content_multiple">
