...
$actionpage = 'charge_base_action.php';
...
if ($id_error == false) {
    $Query = "SELECT id,charge_base from $tablename where id='" . $_REQUEST["id"] . "'";
    $DB->query($Query);
...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="charge_base_grid.php">Charge Base</a></li>
                                ...
                                <table cellspacing="0">
                                    <tr>
                                        <td  class="form_label_split2">
                                            <span class="red">*&nbsp;</span>Charge Base
                                        </td>
                                        <td class="form_content_split2" align="center">
                                            <input type="text" required name="charge_base" class="form-control" value="<?php if ($id_error == false) echo $charge_base; ?>">
                                        </td>
                                    </tr>
                                </table>
                            </div>
