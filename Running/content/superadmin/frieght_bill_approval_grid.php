...
$return_page = '../superadmin/frieght_bill_approval_grid.php';
                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,branch,client_name,service_tax_payable_by,bill_no,bill_date,frieght_status from $tablename where frieght_status='Approval'";
                                $UDB->query($Query);
