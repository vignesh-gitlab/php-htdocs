...
if ($_REQUEST["form_action"] == "Insert") {
    ...
    $Query = "update $tablename set order_no='" . $_REQUEST["order_no"] . "', branch_code='" . $_REQUEST["branch_code"] . "',branch_name='" . $_REQUEST["branch_name"] . "',description='" . $_REQUEST["description"] . "',po_no='" . $_REQUEST["po_no"] . "',po_amount='" . $_REQUEST["po_amount"] . "',payment_type='" . $_REQUEST["payment_type"] . "',amount='" . $_REQUEST["amount"] . "',payment_description='" . $_REQUEST["payment_description"] . "' where id=" . $_REQUEST["id"];
    $UDB->query($Query);
