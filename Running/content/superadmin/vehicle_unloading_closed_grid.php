...
$return_page = '../superadmin/vehicle_unloading_grid.php';
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id="example" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,order_no,client_name,client_division,client_branch,orgin,destination,vehicle_type,vehicle_no,dispatch_date,dispatch_time,landing_date,landing_time,unloading_date,unloading_time,action_user from $tablename where unloading_status='Reported' order by order_no";
                                $UDB->query($Query);
