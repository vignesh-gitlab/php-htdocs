...
<script type="text/javascript">
    function AjaxFunction_display_lane_id(customer_name)
    {
        alert(customer_name);
        var httpxml;
        try
        ...
        function stateck()
        {
            ...
            if (httpxml.readyState == 4)
            {
                ...
                if (myarray.length > 0)
                {
                    ...
                    document.getElementById('duration' + line_id).value = myarray[3];
            ...
            <div class="col-xs-12">
                <form role="form" name="form" id="form1" method="post" onsubmit="submit_form()" action="<?php echo $actionpage; ?>" enctype="multipart/form-data" autocomplete="<?php echo AUTOCOMPLETE ?>">
                            ...
                            <div class="form_tablebox">
                                <table cellspacing="0">
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <input type="text" name="customer_name" id="customer_name" class="form-control" onclick="AjaxFunction_display_lane_id(this.value)"  value="<?php if ($id_error == false || $client_error == false) echo $customer_name; ?>">
                                        </td>
                                    ...
                                    for ($i = 1; $i <= 25; $i++) {
                                        ...
                                        <tr>
                                            <td class="form_label_multiple" align="center">
                                                <div class="input-group">
                                                    <input type="text" readonly="true" name="effective_date_item<?php echo $i; ?>" class="form-control pull-right" id="effective_date_item<?php echo $i; ?>" onfocus="pick_date(this.id);" value="<?php
                                                    if ($id_error == false || $form_error == false) {
                    ...
                    <div class="box-footer">
                        ...
                        if ($form_error == false) {
                            echo'<input type="text" name="form_action1" value="Copy"/>';
                            echo'<input type="text" name="id" value="' . $_REQUEST["id"] . '"/>';
                        }
                        if ($id_error == false) {
                            echo'<input type="text" name="form_action" value="Update"/>';
                            echo'<input type="text" name="contract_no" value="' . $_REQUEST["contract_no"] . '"/>';
                        } else {
                            echo'<input type="text" name="form_action" value="Insert"/>';
                        }
                        ?>
