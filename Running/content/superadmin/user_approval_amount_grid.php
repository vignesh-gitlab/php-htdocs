...
<?php
$form_page = 'user_approval_amount_form.php';
$tablename = 'master_user_approval_amount';
$return_page = '../superadmin/user_approval_amount_grid.php';
?>
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">User Approval Amount</li>
        </ol>
    </section>
    <!-- Main content -->
                    ...
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            <thead>
                                ...
                                <tr>
                                    <th>Action</th>
                                    <th>User Approval Amount</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                $Query = "SELECT id,user_approval_amount from $tablename order by user_approval_amount";
                                $DB->query($Query);
                                while ($DB->Multicoloums()) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $DB->Record["user_approval_amount"] ?></td>
                                        <?php
                                    }
                                    ?>
                                </tr>
