...
$return_page = '../superadmin/customer_order_grid.php';
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id="example" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,order_no,client_name,client_division,client_branch,order_date,order_time,vehicle_required_date,vehicle_required_time,orgin,destination,vehicle_type,vehicle_ownership_type,vehicle_owner,primary_secondary,action_user from $tablename where order_status='Booked' order by order_no";
                                $UDB->query($Query);
