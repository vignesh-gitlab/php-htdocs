...
$actionpage = 'type_of_movement_action.php';
...
if ($id_error == false) {
    $Query = "SELECT id,type_of_movement from $tablename where id='" . $_REQUEST["id"] . "'";
    $DB->query($Query);
...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="type_of_movement_grid.php">Type Of Movement</a></li>
                                ...
                                <table cellspacing="0">
                                    <tr>
                                        <td  class="form_label_split2">
                                            <span class="red">*&nbsp;</span>Type of Movement
                                        </td>
                                        <td class="form_content_split2" align="center">
                                            <input type="text" required name="type_of_movement" class="form-control" value="<?php if ($id_error == false) echo $type_of_movement; ?>">
                                        </td>
                                    </tr>
                                </table>
                            </div>
