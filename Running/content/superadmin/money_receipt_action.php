...
if ($_REQUEST["form_action"] == "Insert") {
    ...
    $UDB->query($Query);
    /* $Query = "update sr_client set advance_amount='" . $_REQUEST["advance"] . "' where client_name='" . $_REQUEST["client_name"] . "'";
      $DB->query($Query);
      $Query = "insert into sr_payments values('NULL','Money Receipt','" . $_REQUEST["bmr_no"] . "','" . $_REQUEST["mr_date"] . "','" . $_REQUEST["advance"] . "','" . $_REQUEST["payment_mode"] . "','" . $_REQUEST["payment_description"] . "','" . $_REQUEST["received_from"] . "','" . $_REQUEST["received_by"] . "','" . $_REQUEST["client_name"] . "','" . $_REQUEST["division_name"] . "','" . $_REQUEST["branch_name"] . "')";
      $UDB->query($Query); */
