...
$actionpage = 'user_type_action.php';
...
if ($id_error == false) {
    $Query = "SELECT id,usertype from $tablename where id='" . $_REQUEST["id"] . "'";
    $DB->query($Query);
...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="user_type_grid.php">User Type</a></li>
                                ...
                                <table cellspacing="0">
                                    <tr>
                                        <td  class="form_label_split2">
                                            <span class="red">*&nbsp;</span>User Type
                                        </td>
                                        <td class="form_content_split2" align="center">
                                            <input type="text" required name="usertype" class="form-control" value="<?php if ($id_error == false) echo $usertype; ?>">
                                        </td>
                                    </tr>
                                </table>
                            </div>
