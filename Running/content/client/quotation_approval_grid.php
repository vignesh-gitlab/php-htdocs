...
$return_page = '../client/quotation_approval_grid.php';
?>
                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <table id="example" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,quotation_id,quotation_no,quotation_date,vehicle_type,client_name,division_name,branch_name,city,quotation_status from $tablename where quotation_status='Approval' and quotation_status<>'Close'  and client_name='" . $Display_Name . "' order by quotation_no desc";
                                $UDB->query($Query);
