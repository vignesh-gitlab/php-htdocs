...
$actionpage = 'vehicle_ownership_action.php';
...
if ($id_error == false) {
    $Query = "SELECT id,ownership from $tablename where id='" . $_REQUEST["id"] . "'";
    $DB->query($Query);
...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="vehicle_ownership_grid.php">Vehicle Ownership</a></li>
                                ...
                                <table cellspacing="0">
                                    <tr>
                                        <td  class="form_label_split2">
                                            <span class="red">*&nbsp;</span>Vehicle Ownership
                                        </td>
                                        <td class="form_content_split2" align="center">
                                            <input type="text" required name="ownership" class="form-control" value="<?php if ($id_error == false) echo $ownership; ?>">
                                        </td>
                                    </tr>
                                </table>
                            </div>
