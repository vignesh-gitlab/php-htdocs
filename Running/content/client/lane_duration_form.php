...
$actionpage = 'lane_duration_action.php';
...
if ($id_error == false) {
    $Query = "SELECT id,duration from $tablename where id='" . $_REQUEST["id"] . "'";
    $DB->query($Query);
    while ($DB->Multicoloums()) {
        $lane_duration = $DB->Record["duration"];
    }
}
?>
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="lane_duration_grid.php">Lane Duration</a></li>
                                ...
                                <table cellspacing="0">
                                    <tr>
                                        <td  class="form_label_split2">
                                            <span class="red">*&nbsp;</span>Lane Duration
                                        </td>
                                        <td class="form_content_split2" align="center">
                                            <input type="text" required name="lane_duration" class="form-control" value="<?php if ($id_error == false) echo $lane_duration; ?>" autofocus>
                                        </td>
                                    </tr>
                                </table>
                            </div>
