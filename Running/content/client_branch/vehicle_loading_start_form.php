...
$actionpage = 'vehicle_loading_start_action.php';
...
if ($orderno_error == false) {
    $Query = "SELECT  id,order_no,so_no,client_name,client_division,client_branch,orgin,destination,vehicle_type,vehicle_no,placement_date,placement_time from sr_vehicle_placement where order_no='" . $_REQUEST["order_no"] . "'";
    $UDB->query($Query);
...
if ($id_error == false) {
    $Query = "SELECT  id,order_no,so_no,client_name,client_division,client_branch,orgin,destination,vehicle_type,vehicle_no,placement_date,placement_time,loading_start_date,loading_start_time from $tablename where id='" . $_REQUEST["id"] . "'";
    $UDB->query($Query);
    while ($UDB->Multicoloums()) {
        $order_no = $UDB->Record["order_no"];
        $so_no = $UDB->Record["so_no"];
...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="vehicle_loading_start_grid.php">Vehicle Loading - Start</a></li>
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <div class="input-group">
                                                <input type="text" readonly="true" name="loading_start_date" class="form-control pull-right" id="loading_date" onfocus="pick_date(this.id);" value="<?php
                                                if ($id_error == false) {
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <div class="bootstrap-timepicker">
                                                <div class="input-group">
                                                    <input type="text" readonly name="loading_start_time" class="form-control timepicker" value="<?php
                                                    if ($id_error == false) {
                                                        echo $loading_start_time;
                                                    } else {
                                                        echo date('h:i A');
                                                    }
                                                    ?>">
