...
<?php
$form_page = 'client_branch_form.php';
$tablename = 'sr_client';
$return_page = '../client_branch/client_branch_grid.php';
$view_page = 'client_branch_view_grid.php';
...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Client Branch</li>
        </ol>
    </section>
    <!-- Main content -->
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id="example" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,client_name,division_name,branch_name,address_line1,address_line2,city,pincode,telephone_no,mobile_no,fax_no,email_id from $tablename where company_type='Branch' order by client_name,division_name";
                                $DB->query($Query);
                                while ($DB->Multicoloums()) {
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="<?php echo $view_page . "?id=" . $DB->Record["id"]; ?>" title="View"><i class="fa fa-fw fa-indent"></i></a>
                                        </td>
                                        <td><?php echo $DB->Record["client_name"] ?></td>
                                        <td><?php echo $DB->Record["division_name"] ?></td>
