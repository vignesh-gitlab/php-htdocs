                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,order_no,client_name,client_division,client_branch,orgin,destination,vehicle_type,vehicle_no,placement_date,placement_time,loading_start_date,loading_start_time,action_user from $tablename where loading_status='Loaded'  and client_name='" . $Display_Name . "' and (client_branch='" . $_SESSION["branch"] . "' or client_branch='" . $_SESSION["branch1"] . "' or client_branch='" . $_SESSION["branch2"] . "') order by order_no";
                                $UDB->query($Query);
