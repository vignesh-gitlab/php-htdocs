                                    ...
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <div class="input-group">
                                                <input type="text" readonly="true" name="quotation_date" class="form-control pull-right" id="quotation_date" onfocus="pick_date(this.id);" value="<?php
                                                if ($id_error == false) {
                                                    echo $quotation_date;
                                                } else {
                                                    echo date('d-m-Y');
                                ...
                                <table cellspacing="0">
                                    ...
                                    for ($i = 1; $i <= 25; $i++) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="form_content_multiple">
                                                <input type="text" style="text-align:right;" readonly id="amount<?php echo $i; ?>"  name="amount<?php echo $i; ?>" onclick="display_amount(<?php echo $i; ?>)" class="form-control" value="<?php
                                                if ($id_error == false) {
