...
$return_page = '../client_branch/sales_order_grid.php';
?>
                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <table id="example" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,so_id,so_no,so_date,quotation_ref_no,vehicle_type,vehicle_required_date,client_name,city,so_status from $tablename where so_status<>'Close'  and client_name='" . $Display_Name . "' and (branch_name='" . $_SESSION["branch"] . "' or branch_name='" . $_SESSION["branch1"] . "' or branch_name='" . $_SESSION["branch2"] . "')  order by abs(so_no)";
                                $UDB->query($Query);
