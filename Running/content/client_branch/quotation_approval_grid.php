...
$return_page = '../client_branch/quotation_approval_grid.php';
?>
                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <table id="example" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,quotation_id,quotation_no,quotation_date,vehicle_type,client_name,division_name,branch_name,city,quotation_status from $tablename where quotation_status='Approval' and quotation_status<>'Close'  and client_name='" . $Display_Name . "' and (branch_name='" . $_SESSION["branch"] . "' or branch_name='" . $_SESSION["branch1"] . "' or branch_name='" . $_SESSION["branch2"] . "')   order by quotation_no desc";
                                $UDB->query($Query);
