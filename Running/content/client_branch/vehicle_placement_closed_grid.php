                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,order_no,client_name,client_division,client_branch,vehicle_required_date,vehicle_required_time,orgin,destination,vehicle_type,vehicle_no,driver_type,escart_option,tracking_device,placement_date,placement_time,ontime_placement,late_reporting_remarks,action_user from $tablename where placement_status='Released'  and client_name='" . $Display_Name . "' and (client_branch='" . $_SESSION["branch"] . "' or client_branch='" . $_SESSION["branch1"] . "' or client_branch='" . $_SESSION["branch2"] . "') order by order_no";
                                $UDB->query($Query);
