...
<?php
$form_page = 'vehicle_dispatch_edd_form.php';
$status_form_page = 'vehicle_status_form.php';
$child_form_page = 'vehicle_landing_edd_form.php';
$tablename = 'sr_vehicle_dispatch';
$return_page = '../client_branch/vehicle_dispatch_edd_grid.php';
...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Vehicle Delay EDD</li>
        </ol>
    </section>
    <!-- Main content -->
