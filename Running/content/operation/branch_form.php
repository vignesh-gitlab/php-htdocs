...
if ($id_error == false) {
    $Query = "SELECT  id,branch_id,branch_code,zonal_code,company_name,company_caption,address_line1,address_line2,city,pincode,telephone_no,mobile_no,fax_no,email_id,website_id,tin_no,cst_no from $tablename where id='" . $_REQUEST["id"] . "'";
    $DB->query($Query);
                            ...
                            <div class="form_tablebox">
                                <table cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <select class="form-control dropdown_padding" name="zonal_code">
                                                <option>Select</option>
                                                <?php
                                                $Query = "select distinct(zonal_code) from sr_company order by zonal_code";
                                                $DB->query($Query);
