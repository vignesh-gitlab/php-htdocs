...
$contract_page = 'contract_form.php';
$tablename = 'sr_client';
$return_page = '../superadmin/client_grid.php';
$view_page = 'client_view_grid.php';
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id="example" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,client_name,address_line1,address_line2,city,pincode,telephone_no,mobile_no,fax_no,email_id,company_type from $tablename where company_type='Head Office' order by client_name";
                                $DB->query($Query);
                                while ($DB->Multicoloums()) {
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="<?php echo $contract_page . "?id=" . $DB->Record["id"]; ?>" title="Add Contract"><i class="fa fa-fw fa-plus"></i></a>
                                        </td>
