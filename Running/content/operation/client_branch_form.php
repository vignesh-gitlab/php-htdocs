...
$actionpage = 'client_branch_action.php';
$tablename = 'sr_client';
...
if ($id_error == false) {
    $Query = "SELECT  id,client_name,division_name,branch_name,address_line1,address_line2,city,pincode,telephone_no,mobile_no,fax_no,email_id,tin_no,contact_person_name1,telephone_no1,mobile_no1,email_id1,contact_person_name2,telephone_no2,mobile_no2,email_id2,contact_person_name3,telephone_no3,mobile_no3,email_id3,cst_no from $tablename where id='" . $_REQUEST["id"] . "'";
    $DB->query($Query);
                            ...
                            <div class="form_tablebox">
                                <table cellspacing="0">
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <select class="form-control dropdown_padding" name="division_name">
                                                <option>Select</option>
                                                <?php
                                                $Query = "select distinct(division_name) from sr_client where company_type='Division' order by division_name";
                                                $DB->query($Query);
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <input type="text" required name="branch_name" class="form-control" value="<?php if ($id_error == false) echo $branch_name; ?>">
                                        </td>
