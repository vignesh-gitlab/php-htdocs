...
$actionpage = 'bill_type_action.php';
...
if ($id_error == false) {
    $Query = "SELECT id,bill_type from $tablename where id='" . $_REQUEST["id"] . "'";
    $DB->query($Query);
    while ($DB->Multicoloums()) {
        $bill_type = $DB->Record["bill_type"];
    }
}
?>
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="bill_type_grid.php">Bill Type</a></li>
                                ...
                                <table cellspacing="0">
                                    <tr>
                                        <td  class="form_label_split2">
                                            <span class="red">*&nbsp;</span>Bill Type
                                        </td>
                                        <td class="form_content_split2" align="center">
                                            <input type="text" required name="bill_type" class="form-control" value="<?php if ($id_error == false) echo $bill_type; ?>" autofocus>
                                        </td>
                                    </tr>
                                </table>
                            </div>
