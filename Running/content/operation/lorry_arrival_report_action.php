...
if ($_REQUEST["form_action"] == "Insert") {
    ...
    $Query = "insert into $tablename values(NULL,'" . $_REQUEST["order_no"] . "','" . $_REQUEST["order_date"] . "','" . $_REQUEST["so_no"] . "','" . $_REQUEST["so_date"] . "','" . $new_max_id . "','" . $new_max_orderno . "','" . $_REQUEST["branch"] . "','" . $_REQUEST["lorry_no"] . "','" . $_REQUEST["lar_date"] . "','" . $_REQUEST["lorry_from"] . "','" . $_REQUEST["dispatched_on"] . "','" . $_REQUEST["lorry_to"] . "','" . $_REQUEST["reporting_date"] . "','" . $_REQUEST["chellan_no"] . "','" . $_REQUEST["unloading_date"] . "','" . $_REQUEST["packages_load"] . "','" . $_REQUEST["packages_received"] . "','" . $_REQUEST["short_received"] . "','" . $_REQUEST["short_loss"] . "','" . $_REQUEST["damage_received"] . "','" . $_REQUEST["damage_loss"] . "','" . $_REQUEST["remarks_received"] . "','" . $_REQUEST["remarks_loss"] . "','" . $_REQUEST["consignment_received"] . "','" . $_REQUEST["consignment_loss"] . "','" . $_REQUEST["party_name_received"] . "','" . $_REQUEST["party_name_loss"] . "','Not Yet Released')";
    $UDB->query($Query);
    ...
    $Query = "update $tablename set lar_no='" . $_REQUEST["lar_no"] . "',branch='" . $_REQUEST["branch"] . "',lorry_no='" . $_REQUEST["lorry_no"] . "',lar_date='" . $_REQUEST["lar_date"] . "',lorry_from='" . $_REQUEST["lorry_from"] . "',dispatched_on='" . $_REQUEST["dispatched_on"] . "',lorry_to='" . $_REQUEST["lorry_to"] . "',reporting_date='" . $_REQUEST["reporting_date"] . "',chellan_no='" . $_REQUEST["chellan_no"] . "',unloading_date='" . $_REQUEST["unloading_date"] . "',packages_load='" . $_REQUEST["packages_load"] . "',packages_received='" . $_REQUEST["packages_received"] . "',short_received='" . $_REQUEST["short_received"] . "',short_loss='" . $_REQUEST["short_loss"] . "',damage_received='" . $_REQUEST["damage_received"] . "',damage_loss='" . $_REQUEST["damage_loss"] . "',remarks_received='" . $_REQUEST["remarks_received"] . "',remarks_loss='" . $_REQUEST["remarks_loss"] . "',consignment_received='" . $_REQUEST["consignment_received"] . "',consignment_loss='" . $_REQUEST["consignment_loss"] . "',party_name_received='" . $_REQUEST["party_name_received"] . "',party_name_loss='" . $_REQUEST["party_name_loss"] . "' where id=" . $_REQUEST["id"];
    $UDB->query($Query);
