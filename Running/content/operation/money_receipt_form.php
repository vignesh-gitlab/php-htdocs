                            ...
                            <div class="form_tablebox">
                                <table cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <select class="form-control dropdown_padding" name="so_no">
                                                <option>Select</option>
                                                <?php
                                                $Query = "select distinct(so_no) from sr_sales_order order by so_no";
                                                $UDB->query($Query);

                                                while ($UDB->Multicoloums()) {
                                                    if ($id_error == false && $so_no == $UDB->Record["so_no"]) {
                                                        echo'<option selected>' . $UDB->Record["so_no"] . '</option>';
                                                    } else {
                                                        echo'<option>' . $UDB->Record["so_no"] . '</option>';
                                                    }
                                                }
                                                ?>
                                            </select>
