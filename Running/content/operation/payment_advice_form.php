...
if ($id_error == false) {
    ...
    $Query = "SELECT id,lr_no,challan_no,lr_date,un_ld_date,bal_amt,hamali_paid,hamali_collect,tds_amt,claim_amt,late_delivery,destination,line_total from $tablename1 where order_no='" . $order_no . "'";
    $UDB->query($Query);
    while ($UDB->Multicoloums()) {
