...
if ($_REQUEST["form_action"] == "Insert") {
    $Query = "insert into $tablename values(NULL,'" . $_REQUEST["order_no"] . "','" . $_REQUEST["order_date"] . "','" . $_REQUEST["so_no"] . "','" . $_REQUEST["so_date"] . "','" . $_REQUEST["branch_code"] . "','" . $_REQUEST["branch_city"] . "','" . $_REQUEST["lorry_chellan_no"] . "','" . $_REQUEST["lorry_chellan_date"] . "','" . $_REQUEST["lorry_from"] . "','" . $_REQUEST["lorry_to"] . "','" . $_REQUEST["lorry_no"] . "','" . $_REQUEST["branch"] . "','" . $_REQUEST["chassis_no"] . "','" . $_REQUEST["engine_no"] . "','" . $_REQUEST["owner_name"] . "','" . $_REQUEST["owner_address_line1"] . "','" . $_REQUEST["owner_address_line2"] . "','" . $_REQUEST["owner_city"] . "','" . $_REQUEST["owner_pincode"] . "','" . $_REQUEST["driver_name"] . "','" . $_REQUEST["license_no"] . "','" . $_REQUEST["driver_address_line1"] . "','" . $_REQUEST["driver_address_line2"] . "','" . $_REQUEST["driver_city"] . "','" . $_REQUEST["driver_pincode"] . "','" . $_REQUEST["lorry_model"] . "','" . $_REQUEST["lorry_color"] . "','" . $_REQUEST["lorry_make"] . "','" . $_REQUEST["permit_status"] . "','" . $_REQUEST["permit_valid_upto"] . "','" . $_REQUEST["ongaged_through"] . "','" . $_REQUEST["delivery_date"] . "','" . $_REQUEST["destination_address_line1"] . "','" . $_REQUEST["destination_address_line2"] . "','" . $_REQUEST["destination_city"] . "','" . $_REQUEST["destination_pincode"] . "','" . $_REQUEST["total_packages"] . "','" . $_REQUEST["rate_per_ton"] . "','" . $_REQUEST["rate_per_kg"] . "','" . $_REQUEST["frieght"] . "','" . $_REQUEST["extra_for"] . "','" . $_REQUEST["total"] . "','" . $_REQUEST["advance"] . "','" . $_REQUEST["less_tds"] . "','" . $_REQUEST["balance"] . "','Not Yet Released')";
    $UDB->query($Query);

    for ($i = 1; $i <= $_REQUEST["product_count"]; $i++) {
        if ($_REQUEST["code" . $i] != "Select" || (isset($_REQUEST["consignment_no" . $i]) && !empty($_REQUEST["consignment_no" . $i]))) {
            $Query = "insert into $tablename1 values(NULL,'" . $_REQUEST["order_no"] . "','" . $_REQUEST["lorry_chellan_no"] . "','" . $_REQUEST["code" . $i] . "','" . $_REQUEST["consignment_no" . $i] . "','" . $_REQUEST["no_of_packages" . $i] . "','" . $_REQUEST["packing" . $i] . "','" . $_REQUEST["description" . $i] . "','" . $_REQUEST["weight" . $i] . "','" . $_REQUEST["destination" . $i] . "','" . $_REQUEST["to_pay" . $i] . "')";
            $UDB->query($Query);
        }
    }
