...
$actionpage = 'vehicle_unloading_action.php';
...
if ($orderno_error == false) {
    $Query = "SELECT  order_no,so_no,client_name,client_division,client_branch,orgin,destination,vehicle_type,vehicle_no,dispatch_date,dispatch_time,expected_dateof_delivery,landing_date,landing_time from sr_vehicle_landing where order_no='" . $_REQUEST["order_no"] . "'";
    $UDB->query($Query);
...
if ($id_error == false) {
    $Query = "SELECT  id,order_no,so_no,client_name,client_division,client_branch,orgin,destination,vehicle_type,vehicle_no,dispatch_date,dispatch_time,expected_dateof_delivery,landing_date,landing_time,unloading_date,unloading_time from $tablename where id='" . $_REQUEST["id"] . "'";
    $UDB->query($Query);
    while ($UDB->Multicoloums()) {
        $order_no = $UDB->Record["order_no"];
        $so_no = $UDB->Record["so_no"];
...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="vehicle_unloading_grid.php">Vehicle Unloading</a></li>
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <div class="input-group">
                                                ...
                                                <input type="text" readonly="true" name="unloading_date" class="form-control pull-right" id="landing_date" onfocus="pick_date(this.id);" value="<?php
                                                if ($id_error == false) {
                                                    echo $unloading_date;
                                                } else {
                                                    echo date('d-m-Y');
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <div class="bootstrap-timepicker">
                                                <div class="input-group">
                                                    <input type="text" readonly name="unloading_time" class="form-control timepicker" value="<?php
                                                    if ($id_error == false) {
                                                        echo $unloading_time;
                                                    } else {
                                                        echo date('h:i A');
