...
<?php
if ($id_error == false) {
    $Query = "SELECT quotation_id,quotation_no,quotation_date,description,vehicle_required_date,vehicle_type,client_name,division_name,branch_name,address_line1,address_line2,city,pincode,contact_no,terms_and_condition,sub_total,total_tax,discount,grand_total from $tablename where id='" . $_REQUEST["id"] . "'";
    $UDB->query($Query);
                                ...
                                <table cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_content_split2" rowspan="3" align="center">
                                            <textarea name="reference" style="height:78px;" class="form-control" autofocus><?php if ($id_error == false) echo $reference; ?></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td  class="form_label_split2" rowspan="3">
