...
$actionpage = 'service_tax_payable_by_action.php';
...
if ($id_error == false) {
    $Query = "SELECT id,service_tax_payable_by from $tablename where id='" . $_REQUEST["id"] . "'";
    $DB->query($Query);
    while ($DB->Multicoloums()) {
        $service_tax_payable_by = $DB->Record["service_tax_payable_by"];
    }
}
?>
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="service_tax_payable_by_grid.php">Service Tax Payable By</a></li>
                                ...
                                <table cellspacing="0">
                                    <tr>
                                        <td  class="form_label_split2">
                                            <span class="red">*&nbsp;</span>Payable By
                                        </td>
                                        <td class="form_content_split2" align="center">
                                            <input type="text" required name="service_tax_payable_by" class="form-control" value="<?php if ($id_error == false) echo $service_tax_payable_by; ?>" autofocus>
                                        </td>
                                    </tr>
                                </table>
                            </div>
