                            ...
                            <div class="form_tablebox">
                                <table cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_content_multiple">
                                            <input type="text" name="consignment_received" style="text-align: center;" class="form-control" value="<?php if ($id_error == false) echo $consignment_received; ?>">
                                        </td>
                                        <td class="form_content_multiple">
                                            <input type="text" name="consignment_loss" style="text-align: center;" class="form-control" value="<?php if ($id_error == false) echo $consignment_loss; ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="form_label_multiple">
                                        ...
                                        <td class="form_content_multiple">
                                            <input type="text" name="party_name_received" style="text-align: center;" class="form-control" value="<?php if ($id_error == false) echo $party_name_received; ?>">
                                        </td>
                                        <td class="form_content_multiple">
