...
<?php
$form_page = 'escort_form.php';
$tablename = 'sr_escort';
$return_page = '../client_division/escort_grid.php';
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id="example" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,escart_name,address_line1,address_line2,city,pincode,telephone_no,mobile_no,email_id,escart_type,contractor_name,description from $tablename order by escart_name";
                                $DB->query($Query);
                                while ($DB->Multicoloums()) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $DB->Record["escart_name"] ?></td>
                                        <td>
                                            <?php
                                        ...
                                        <td><?php echo $DB->Record["escart_type"] ?></td>
                                        <?php
                                    }
                                    ?>
                                </tr>
