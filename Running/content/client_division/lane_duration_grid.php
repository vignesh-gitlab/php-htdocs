...
<?php
$form_page = 'lane_duration_form.php';
$tablename = 'master_duration';
$return_page = '../client_division/lane_duration_grid.php';
?>
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Lane Duration</li>
        </ol>
    </section>
    <!-- Main content -->
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,duration from $tablename order by duration";
                                $DB->query($Query);
