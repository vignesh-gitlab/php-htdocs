...
$return_page = '../client_division/frieght_bill_grid.php';
                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,branch,client_name,division_name,service_tax_payable_by,bill_no,bill_date,frieght_status from $tablename where frieght_status<>'Close'  and client_name='" . $Display_Name . "' and (division_name='" . $_SESSION["division"] . "' or division_name='" . $_SESSION["division1"] . "' or division_name='" . $_SESSION["division2"] . "')";
                                $UDB->query($Query);
