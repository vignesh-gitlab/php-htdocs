...
<?php
$form_page = 'payment_mode_form.php';
$tablename = 'master_payment_mode';
$return_page = '../client_division/payment_mode_grid.php';
?>
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id="example" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,payment_mode from $tablename order by payment_mode";
                                $DB->query($Query);
                                while ($DB->Multicoloums()) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $DB->Record["payment_mode"] ?></td>
                                        <?php
                                    }
                                    ?>
                                </tr>
