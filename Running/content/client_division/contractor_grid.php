...
<?php
$form_page = 'contractor_form.php';
$tablename = 'sr_contractor';
$return_page = '../client_division/contractor_grid.php';
//$view_page = 'contractor_view_grid.php';
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id="example" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,contractor_name,address_line1,address_line2,city,pincode,telephone_no,mobile_no,fax_no,email_id,service_product1,service_product2,service_product3,service_product4 from $tablename order by contractor_name";
                                $DB->query($Query);
                                while ($DB->Multicoloums()) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $DB->Record["contractor_name"] ?></td>
                                        <td>
                                            <?php
