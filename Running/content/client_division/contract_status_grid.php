...
<?php
$form_page = 'contract_status_form.php';
$tablename = 'sr_contract_status';
$return_page = '../client_division/contract_status_grid.php';
?>
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Vehicle Contract Status</li>
        </ol>
    </section>
    <!-- Main content -->
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,contract_status from $tablename order by contract_status";
                                $DB->query($Query);
                                while ($DB->Multicoloums()) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $DB->Record["contract_status"] ?></td>
                                        <?php
                                    }
                                    ?>
                                </tr>
