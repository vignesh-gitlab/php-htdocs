...
$actionpage = 'customer_order_duplicate_action.php';
                                ...
                                <table cellspacing="0">
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <?php
                                            $Query = "SELECT max(cast(order_id as unsigned))as max_id from sr_customer_order";
                                            $UDB->query($Query);
                                            while ($UDB->Multicoloums()) {
                                            ...
                                            $new_max_id = $max_id + 1;
                                            ?>
                                            <input type="hidden" name="order_id" class="form-control" value="<?php echo $new_max_id; ?>">
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <select class="form-control dropdown_padding" name="client_division" id="client_division" onchange="AjaxFunction_display_branch_name(this.value)">
                                                ...
                                                while ($DB->Multicoloums()) {
                                                    if ($id_error == false && $client_division == $DB->Record["division_name"]) {
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <select class="form-control dropdown_padding" name="client_branch" id="client_branch">
                                                ...
                                                while ($DB->Multicoloums()) {
                                                    if ($id_error == false && $client_branch == $DB->Record["branch_name"]) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <input type="text" required name="destination" class="form-control" value="<?php if ($id_error == false) echo $destination; ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center" rowspan="3">
                                            ...
                                            <input type="text" name="pickup_city" class="form-control" value="<?php if ($id_error == false) echo $pickup_city; ?>" placeholder="City" style="float:left; width:70%;">
