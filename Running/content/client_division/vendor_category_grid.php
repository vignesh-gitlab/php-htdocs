...
<?php
$form_page = 'vendor_category_form.php';
$tablename = 'master_vendor_category';
$return_page = '../client_division/vendor_category_grid.php';
?>
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,vendor_category from $tablename order by vendor_category";
                                $DB->query($Query);
                                while ($DB->Multicoloums()) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $DB->Record["vendor_category"] ?></td>
                                        <?php
                                    }
                                    ?>
                                </tr>
