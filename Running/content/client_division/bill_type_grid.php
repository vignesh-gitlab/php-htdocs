...
<?php
$form_page = 'bill_type_form.php';
$tablename = 'master_bill_type';
$return_page = '../client_division/bill_type_grid.php';
?>
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,bill_type from $tablename order by bill_type";
                                $DB->query($Query);
                                while ($DB->Multicoloums()) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $DB->Record["bill_type"] ?></td>
                                        <?php
                                    }
                                    ?>
                                </tr>
