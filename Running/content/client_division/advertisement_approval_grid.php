...
$return_page = '../client_division/advertisement_approval_grid.php';
...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Advertisement Approval</li>
        </ol>
    </section>
    <!-- Main content -->
                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,advertisement_id,advertisement_no,description,amount,ad_status from $tablename where ad_status='Approval'";
                                $UDB->query($Query);
