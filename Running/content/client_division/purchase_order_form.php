...
if ($id_error == false) {
    $Query = "SELECT id, po_id,po_no,po_date,so_no,description,vehicle_required_date,vehicle_type,tax_category,client_name,contractor_name,contractor_address_line1,contractor_address_line2,contractor_city,contractor_pincode,contractor_contact_no,terms_and_condition, sub_total, total_tax, discount, grand_total from $tablename where id = '" . $_REQUEST["id"] . "'";
    $UDB->query($Query);
    while ($UDB->Multicoloums()) {
