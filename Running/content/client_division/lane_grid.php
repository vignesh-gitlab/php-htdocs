...
<?php
$form_page = 'lane_form.php';
$tablename = 'sr_lane';
$return_page = '../client_division/lane_grid.php';
?>
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id="example" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,lane_id,vehicle_type,lane_from,lane_to,total_km_one_way,total_km_trip,rate,duration from $tablename";
                                $DB->query($Query);
