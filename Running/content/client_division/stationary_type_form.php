...
$actionpage = 'stationary_type_action.php';
...
if ($id_error == false) {
    $Query = "SELECT id,stationary_type from $tablename where id='" . $_REQUEST["id"] . "'";
    $DB->query($Query);
    while ($DB->Multicoloums()) {
        $stationary_type = $DB->Record["stationary_type"];
    }
}
?>
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="stationary_type_grid.php">Stationary Type</a></li>
                                ...
                                <table cellspacing="0">
                                    <tr>
                                        <td  class="form_label_split2">
                                            <span class="red">*&nbsp;</span>Stationary Type
                                        </td>
                                        <td class="form_content_split2" align="center">
                                            <input type="text" required name="stationary_type" class="form-control" value="<?php if ($id_error == false) echo $stationary_type; ?>" autofocus>
                                        </td>
                                    </tr>
                                </table>
                            </div>
