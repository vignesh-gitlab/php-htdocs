...
$return_page = '../client_division/quotation_approval_grid.php';
?>
                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <table id="example" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,quotation_id,quotation_no,quotation_date,vehicle_type,client_name,division_name,branch_name,city,quotation_status from $tablename where quotation_status='Approval' and quotation_status<>'Close'  and client_name='" . $Display_Name . "' and (division_name='" . $_SESSION["division"] . "' or division_name='" . $_SESSION["division1"] . "' or division_name='" . $_SESSION["division2"] . "') order by quotation_no desc";
                                $UDB->query($Query);
                                while ($UDB->Multicoloums()) {
                                    ...
                                    <tr>
                                        <td class="no-print">
                                            ...
                                            <a href="<?php echo $form_page . "?id=" . $UDB->Record["id"]; ?>" title="View"><i class="fa fa-fw fa-edit"></i></a>
