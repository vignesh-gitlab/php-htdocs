...
<?php
$form_page = 'stationary_form.php';
$tablename = 'sr_stationary';
$return_page = '../client_division/stationary_grid.php';
?>
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id="example" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,book_type,from_no,to_no,branch_name,branch_code from $tablename order by branch_name";
                                $DB->query($Query);
                                while ($DB->Multicoloums()) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $DB->Record["book_type"] ?></td>
                                        <td><?php echo $DB->Record["from_no"] ?></td>
                                        <td><?php echo $DB->Record["to_no"] ?></td>
                                        <?php
                                    }
                                    ?>
                                </tr>
