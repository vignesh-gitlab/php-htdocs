...
$actionpage = 'bank_name_action.php';
...
if ($id_error == false) {
    $Query = "SELECT id,bank_name from $tablename where id='" . $_REQUEST["id"] . "'";
    $DB->query($Query);
...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="bank_name_grid.php">Bank Name</a></li>
                                ...
                                <table cellspacing="0">
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <input type="text" required name="bank_name" class="form-control" value="<?php if ($id_error == false) echo $bank_name; ?>" autofocus>
                                        </td>
                                    </tr>
                                </table>
                            </div>
