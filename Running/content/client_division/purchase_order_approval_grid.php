...
$return_page = '../client_division/purchase_order_approval_grid.php';
?>
                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <table id="example" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,po_id,po_no,po_date,so_no,vehicle_type,client_name,contractor_name,contractor_city,po_status from $tablename where po_status='Approval' and po_status<>'Close' order by abs(po_no)";
                                $UDB->query($Query);
