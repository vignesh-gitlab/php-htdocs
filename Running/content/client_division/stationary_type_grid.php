...
<?php
$form_page = 'stationary_type_form.php';
$tablename = 'master_stationary_type';
$return_page = '../client_division/stationary_type_grid.php';
?>
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Stationary Type</li>
        </ol>
    </section>
    <!-- Main content -->
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,stationary_type from $tablename order by stationary_type";
                                $DB->query($Query);
                                while ($DB->Multicoloums()) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $DB->Record["stationary_type"] ?></td>
                                        <?php
                                    }
                                    ?>
                                </tr>
