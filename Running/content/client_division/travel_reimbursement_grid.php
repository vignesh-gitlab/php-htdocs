...
$return_page = '../client_division/travel_reimbursement_grid.php';
                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,travel_reimbursement_no,employee_no,employee_name,amount,tr_status from $tablename";
                                $UDB->query($Query);
                                while ($UDB->Multicoloums()) {
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="<?php echo $form_page . "?travel_reimbursement_no=" . $UDB->Record["travel_reimbursement_no"] . "&approval=Approve" . "&id=" . $UDB->Record["id"]; ?>" title="Approve"><i class="fa fa-fw fa-check"></i></a>
                                        </td>
