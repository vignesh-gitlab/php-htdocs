...
<?php
$form_page = 'service_product_form.php';
$tablename = 'master_service_product';
$return_page = '../client_division/service_product_grid.php';
?>
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,service_product from $tablename order by service_product";
                                $DB->query($Query);
                                while ($DB->Multicoloums()) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $DB->Record["service_product"] ?></td>
                                        <?php
                                    }
                                    ?>
                                </tr>
