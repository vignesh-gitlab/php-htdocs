                    ...
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                $Query = "SELECT t1.id,t1.order_no,t1.client_name,t1.client_division,t1.client_branch,t1.orgin,t1.destination,t1.vehicle_type,t1.vehicle_no,t1.dispatch_date,t1.dispatch_time,t1.landing_date,t1.landing_time,t1.unloading_date,t1.unloading_time,t1.vehicle_release_date,t1.vehicle_release_time,t1.action_user,t2.lr_no from sr_vehicle_reporting t1,sr_vehicle_dispatch t2 where reporting_status='Reported' and t1.order_no=t2.order_no  and t1.client_name='" . $Display_Name . "' and (t1.client_division='" . $_SESSION["division"] . "' or t1.client_division='" . $_SESSION["division1"] . "' or t1.client_division='" . $_SESSION["division2"] . "') order by t1.order_no";
                                $UDB->query($Query);
