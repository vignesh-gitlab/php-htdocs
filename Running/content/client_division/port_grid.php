...
<?php
$form_page = 'port_form.php';
$tablename = 'master_ports';
$return_page = '../client_division/port_grid.php';
?>
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,port_type,port_name from $tablename order by port_type";
                                $DB->query($Query);
                                while ($DB->Multicoloums()) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $DB->Record["port_type"] ?></td>
                                        <td><?php echo $DB->Record["port_name"] ?></td>
                                        <?php
                                    }
                                    ?>
                                </tr>
