...
<script type="text/javascript">
    ...
    function AjaxFunction_display_vendor_details(vendor_type)
    {
        var httpxml;
        try
        {
        ...
        function stateck()
        {
            if (httpxml.readyState == 4)
            {
                ...
                if (myarray.length > 0)
                {
                    document.form.vendor_name.value = myarray[0];
                    document.form.vendor_address_line1.value = myarray[1];
                    document.form.vendor_address_line2.value = myarray[2];
                    document.form.vendor_city.value = myarray[3];
                    document.form.vendor_pincode.value = myarray[4];
                    document.form.vendor_contact_no.value = myarray[5];
                }
            }
        }
        var url = "purchase_order_dependent2.php";
        url = url + "?vendor_type=" + vendor_type;
    ...
    function calculate_total(line_id)
    {
        ...
        var tax_amount = 0;
        var temp_total = 0;
        temp_total = Number(unit_total) * 1;
        if (tax_rate != "NA")
        {
            if (tax_type == "Ex")
            {
                tax_amount = ((Number(temp_total) * Number(tax_rate)) / 100);
            }
            if (tax_type == "In")
            {
                //tax_amount = (Number(tax_rate) / 100) * Number(unit_total);
                tax_amount = (Number(temp_total) - (Number(temp_total) * 100) / (Number(tax_rate) + 100));
            }
        }
        if (tax_type == "Ex")
        {
            line_amount = (Number(temp_total));
            total_amount = (Number(temp_total) + Number(tax_amount));
        }
        if (tax_type == "In")
        {
            //line_amount = (Number(unit_total) - Number(tax_amount));
            line_amount = (Number(temp_total) * 100) / (Number(tax_rate) + 100);
            total_amount = (Number(temp_total));
        }
                            ...
                            <div class="form_tablebox">
                                <table cellspacing="0">
                                    <tr>
                                        ...
                                        <td class="form_content_split2" align="center">
                                            <select class="form-control dropdown_padding" name="vendor_type" id="vendor_type" onchange="AjaxFunction_display_vendor_details(this.value)">
                                                <option>Select</option>
                                                <?php
                                                ...
                                                while ($DB->Multicoloums()) {
                                                    if (($id_error == false && $vendor_type == ($DB->Record["vendor_name"] . " : " . $DB->Record["city"]))) {
                                    ...
                                    <tr>
                                        <td class="form_content_split2" align="center">
                                            <input type="text" id="vendor_name" readonly name="vendor_name" class="form-control" placeholder="Vendor Name" value="<?php if (($id_error == false) || ( $wono_error == false )) echo $vendor_name; ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="form_content_split2" align="center">
                                            <input type="text" id="vendor_address_line1" readonly name="vendor_address_line1" class="form-control" placeholder="Address Line 1" value="<?php if (($id_error == false) || ( $wono_error == false )) echo $vendor_address_line1; ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="form_content_split2" align="center">
                                            <input type="text" id="vendor_address_line2" readonly name="vendor_address_line2" class="form-control" placeholder="Address Line 2" value="<?php if (($id_error == false) || ( $wono_error == false )) echo $vendor_address_line2; ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td  class="form_label_split2">
                                            <input type="text" id="vendor_city" name="vendor_city" readonly class="form-control" placeholder="City" style="float:left; width:70%;" value="<?php if (($id_error == false) || ( $wono_error == false )) echo $vendor_city; ?>">
                                            <input type="text" id="vendor_pincode" name="vendor_pincode" readonly class="form-control" placeholder="Pincode" style="float:left; width:30%;" value="<?php if (($id_error == false) || ( $wono_error == false )) echo $vendor_pincode; ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="form_content_split2" align="center">
                                            <input type="text" id="vendor_contact_no" readonly name="vendor_contact_no" class="form-control" placeholder="Contact Number" value="<?php if (($id_error == false) || ( $wono_error == false )) echo $vendor_contact_no; ?>">
                                        </td>
                                    </tr>
                                </table>
                            </div>
                                ...
                                <table cellspacing="0">
                                    ...
                                    for ($i = 1; $i <= 25; $i++) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="form_content_multiple">
                                                <input type="text" style="text-align:right; float:left;" id="line_total<?php echo $i; ?>"  name="line_total<?php echo $i; ?>" class="form-control" value="<?php
