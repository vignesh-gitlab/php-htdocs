...
$action_page = 'cash_receipt_action.php';
$tablename = 'sr_cash_receipt';
$return_page = '../client_division/cash_receipt_grid.php';
                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,order_no,company_name,regd_no,period_from,period_to,total_wages,total_levy,total,cr_status from $tablename";
                                $UDB->query($Query);
                                while ($UDB->Multicoloums()) {
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="<?php echo $form_page . "?order_no=" . $UDB->Record["order_no"] . "&approval=Approve" . "&id=" . $UDB->Record["id"]; ?>" title="Approve"><i class="fa fa-fw fa-check"></i></a>
                                        </td>
