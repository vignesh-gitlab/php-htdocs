...
<?php
$form_page = 'bank_account_type_form.php';
$tablename = 'master_accounttype';
$return_page = '../client_division/bank_account_type_grid.php';
?>
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,account_type from $tablename order by account_type";
                                $DB->query($Query);
                                while ($DB->Multicoloums()) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $DB->Record["account_type"] ?></td>
                                        <?php
                                    }
                                    ?>
                                </tr>
