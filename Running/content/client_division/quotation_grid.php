                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <table id="example" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,quotation_id,quotation_no,quotation_date,vehicle_type,client_name,division_name,branch_name,city,quotation_status from $tablename where quotation_no NOT LIKE '%.%' and quotation_status<>'Close'  and client_name='" . $Display_Name . "' and (division_name='" . $_SESSION["division"] . "' or division_name='" . $_SESSION["division1"] . "' or division_name='" . $_SESSION["division2"] . "') order by quotation_no desc";
                                $UDB->query($Query);
                                while ($UDB->Multicoloums()) {
                                    ...
                                    <tr>
                                        <td class="no-print">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li class="user-footer">
                                                            <div style="text-align:center;">
                                                                ...
                                                                <a href="<?php echo $action_page; ?>?quotation_id=<?php echo $UDB->Record["quotation_id"] ?>&form_action=Delete" id="delete_button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa fa-check"></i> Yes</a>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
                                            <a href="<?php echo $action_page . "?quotation_no=" . $UDB->Record["quotation_no"]; ?>&form_action=Close" title="Close Quotation"><i class="fa fa-fw fa-ban"></i></a>
                                            ...
                                            <a href="<?php echo $form_page . "?id=" . $UDB->Record["id"] . "&form_action=Revise"; ?>" title="Revise"><i class="fa fa-fw  fa-share-square-o"></i></a>
                                            <?php
                                            if ($quotation_count > 1) {
                                                ?>
                                                <a href="<?php echo $child_grid_page . "?quotation_id=" . $UDB->Record["quotation_id"]; ?>" title="View <?php echo ($quotation_count - 1); ?> Revisions"><i class="fa fa-fw  fa-indent"></i></a>
                                                    <?php
                                                }
                                                ?>
    <!--   <a href="<?php echo $so_page . "?quotation_no=" . $UDB->Record["quotation_no"]; ?>" title="Add Sales Order"><i class="fa fa-fw fa-plus"></i></a>-->
                                        </td>
