...
<?php
$form_page = 'client_division_form.php';
$tablename = 'sr_client';
$return_page = '../client_division/client_division_grid.php';
$view_page = 'client_division_view_grid.php';
...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Client Division</li>
        </ol>
    </section>
    <!-- Main content -->
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id="example" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,client_name,division_name,address_line1,address_line2,city,pincode,telephone_no,mobile_no,fax_no,email_id from $tablename where company_type='Division' order by client_name";
                                $DB->query($Query);
