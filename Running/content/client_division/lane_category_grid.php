...
<?php
$form_page = 'lane_category_form.php';
$tablename = 'master_lane_category';
$return_page = '../client_division/lane_category_grid.php';
?>
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Lane Category</li>
        </ol>
    </section>
    <!-- Main content -->
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,lane_category from $tablename order by lane_category";
                                $DB->query($Query);
                                while ($DB->Multicoloums()) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $DB->Record["lane_category"] ?></td>
                                        <?php
                                    }
                                    ?>
                                </tr>
