...
<?php
$form_page = 'tax_rate_form.php';
$tablename = 'sr_tax_rate';
$return_page = '../client_division/tax_rate_grid.php';
?>
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $Query = "SELECT id,tax_name,tax_rate from $tablename order by tax_name";
                                $DB->query($Query);
                                while ($DB->Multicoloums()) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $DB->Record["tax_name"] ?></td>
                                        <td><?php echo $DB->Record["tax_rate"] ?></td>
                                        <?php
                                    }
                                    ?>
                                </tr>
