!function (a) {
    ...
    b.prototype = {constructor: b, _sanitizeNumber: function (a) {
            ...
            return g /= f > 0 && 1 >= f ? f : 2 - f, f /= 2, g > 1 && (g = 1), {h: e, s: g, l: f, a: d}
        ...
        }, stringParsers: [{re: /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/, format: "hex", parse: function (a) {
    ...
    d.version = "2.0.0-beta", d.Color = b, d.prototype = {constructor: d, destroy: function () {
            ...
            if (38 === a.keyCode)
                this.color.value.a < 1 && (this.color.value.a = Math.round(100 * (this.color.value.a + .01)) / 100), this.update(!0);
            else if (40 === a.keyCode)
                this.color.value.a > 0 && (this.color.value.a = Math.round(100 * (this.color.value.a - .01)) / 100), this.update(!0);
            else {
        ...
        return this.each(function () {
            var c = a(this), e = c.data("colorpicker"), f = "object" == typeof b ? b : {};
            e || "string" == typeof b ? "string" == typeof b && e[b].apply(e, Array.prototype.slice.call(arguments, 1)) : c.data("colorpicker", new d(this, f))
        })
