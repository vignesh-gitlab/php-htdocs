 ...
 */
        (function () {
            ...
            window.CKEDITOR || (window.CKEDITOR = function () {
                var a = {timestamp: "DBAA", version: "4.3.1", revision: "3ecd0b8", rnd: Math.floor(900 * Math.random()) + 100, _: {pending: []}, status: "unloaded", basePath: function () {
                        ...
                        return function (d) {
                            ...
                            if (1 == a.length)
                                if (document.addEventListener)
                                    document.addEventListener("DOMContentLoaded", b, !1), window.addEventListener("load", b, !1);
            ...
            CKEDITOR.event || (CKEDITOR.event = function () {
                ...
                return{define: function (b, d) {
                        ...
                        function i(a, f, o, q) {
                            a = {name: b, sender: this, editor: a, data: f, listenerData: e, stop: o, cancel: q, removeListener: j};
            ...
            CKEDITOR.env || (CKEDITOR.env = function () {
                ...
                if (b.webkit)
                    a.indexOf("chrome") > -1 ? b.chrome = true : b.safari = true;
                var c = 0;
                if (b.ie) {
                ...
                if (b.quirks)
                    b.cssClass = b.cssClass + " cke_browser_quirks";
                if (b.ie) {
                    b.cssClass = b.cssClass + (" cke_browser_ie" + (b.quirks || b.version < 7 ? "6" : b.version));
                    if (b.quirks)
                        b.cssClass = b.cssClass + " cke_browser_iequirks"
                }
                if (b.gecko)
                    if (c < 10900)
                        b.cssClass = b.cssClass + " cke_browser_gecko18";
                    else if (c <= 11E3)
                        b.cssClass = b.cssClass + " cke_browser_gecko19";
                if (b.air)
                    b.cssClass = b.cssClass + " cke_browser_air";
                if (b.iOS)
                    b.cssClass = b.cssClass + " cke_browser_ios";
                if (b.hidpi)
                    b.cssClass = b.cssClass + " cke_hidpi";
                return b
            }());
            ...
            (function () {
                ...
                CKEDITOR.tools = {arrayCompare: function (b, a) {
                        ...
                        if (b === null || typeof b != "object" ||
                                b instanceof String || b instanceof Number || b instanceof Boolean || b instanceof Date || b instanceof RegExp)
                            return b;
                        a = new b.constructor;
                        for (d in b)
                            a[d] = CKEDITOR.tools.clone(b[d]);
                        ...
                        for (var b = [].concat(b), a, d = [], h = 0; h < b.length; h++)
                            if (a = b[h])
                                / @import | [{}] /.test(a) ? d.push("<style>" + a + "</style>") : d.push('<link type="text/css" rel=stylesheet href="' + a + '">');
                        return d.join("")
                        ...
                        for (var d = ["abbr", "article", "aside", "audio", "bdi", "canvas", "data", "datalist", "details", "figcaption", "figure", "footer",
                            "header", "hgroup", "mark", "meter", "nav", "output", "progress", "section", "summary", "time", "video"], h = d.length, e; h--; ) {
            ...
            CKEDITOR.dtd = function () {
                var a = CKEDITOR.tools.extend, e = function (a, d) {
                    ...
                    return b
                }, b = {}, c = {}, d = {address: 1, article: 1, aside: 1, blockquote: 1, details: 1, div: 1, dl: 1, fieldset: 1, figure: 1, footer: 1, form: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, header: 1, hgroup: 1, hr: 1, menu: 1, nav: 1, ol: 1, p: 1, pre: 1, section: 1, table: 1, ul: 1}, h = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, g = {}, n = {"#": 1}, i = {center: 1, dir: 1, noframes: 1};
                ...
                a(e, {$block: a({audio: 1, dd: 1, dt: 1, figcaption: 1, li: 1, video: 1}, d, i), $blockLimit: {article: 1, aside: 1, audio: 1, body: 1, caption: 1, details: 1, dir: 1,
            ...
            CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {appendTo: function (a, e) {
                    ...
                    var b = this.$.cloneNode(a), c = function (d) {
                        ...
                        if (d.nodeType == CKEDITOR.NODE_ELEMENT) {
                            ...
                            if (a)
                                for (var d = d.childNodes, b = 0; b < d.length; b++)
                                    c(d[b])
                        }
                    };
                    c(b);
                    ...
                    if (!e)
                        b = b.parentNode;
                    for (; b; ) {
                        if (b.nodeName && (c = b.nodeName.toLowerCase(), typeof a == "string" ? c == a : c in a))
                            return new CKEDITOR.dom.node(b);
                        try {
                            b = b.parentNode
                        } catch (d) {
            ...
            CKEDITOR.dom.element.setMarker = function (a, e, b, c) {
                var d = e.getCustomData("list_marker_id") || e.setCustomData("list_marker_id", CKEDITOR.tools.getNextNumber()).getCustomData("list_marker_id"), h = e.getCustomData("list_marker_names") || e.setCustomData("list_marker_names", {}).getCustomData("list_marker_names");
                a[d] = e;
                h[b] = 1;
            ...
            (function () {
                ...
                function b(a) {
                    for (var b = 0, e = 0, n = c[a].length; e < n; e++)
                        b = b + (parseInt(this.getComputedStyle(c[a][e]) || 0, 10) || 0);
                    return b
                }
                CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {type: CKEDITOR.NODE_ELEMENT, addClass: function (a) {
                        ...
                        if (b) {
                            a = RegExp("(?:^|\\s+)" + a + "(?=\\s|$)", "i");
                            if (a.test(b))
                                (b = b.replace(a, "").replace(/^\s+/, "")) ? this.setAttribute("class", b) : this.removeAttribute("class")
                        }
                        return this
                    }, hasClass: function (a) {
                    ...
                    getComputedStyle: CKEDITOR.env.ie ? function (a) {
                        ...
                        var b = this.getName();
                        if (this.isReadOnly() || this.getComputedStyle("display") == "none" || this.getComputedStyle("visibility") == "hidden" || CKEDITOR.dtd.$nonEditable[b] || CKEDITOR.dtd.$empty[b] || this.is("a") && (this.data("cke-saved-name") || this.hasAttribute("name")) && !this.getChildCount())
                            return false;
                        if (a !== false) {
                    ...
                    isEmptyInlineRemoveable: function () {
                        ...
                        for (var a = this.getChildren(), b = 0, c = a.count(); b < c; b++) {
                            var e = a.getItem(b);
                            if (!(e.type == CKEDITOR.NODE_ELEMENT && e.data("cke-bookmark")) && (e.type == CKEDITOR.NODE_ELEMENT && !e.isEmptyInlineRemoveable() || e.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(e.getText())))
                                return false
                        }
                        return true
                        ...
                        function a(b, d, c) {
                            if (d && d.type == CKEDITOR.NODE_ELEMENT) {
                                ...
                                if (b.isIdentical(d)) {
                                    for (var j =
                                            c ? b.getLast() : b.getFirst(); e.length; )
                                        e.shift().move(b, !c);
                                    d.moveChildren(b, !c);
                                    d.remove();
                        ...
                        if (o < 0 || i > 0)
                            q(0, b === true ? o : b === false ? i : o < 0 ? o : i);
                        if (c && (j < 0 || e > 0))
                            q(j < 0 ? j : e, 0)
                        ...
                        for (var c = this.$.attributes, b = b || {}, e = 0; e < c.length; e++) {
                            ...
                            if (!(j in b))
                                if (j == "checked" && (o = this.getAttribute(j)))
                                    a.setAttribute(j, o);
            ...
            (function () {
                function a(a, b) {
                    ...
                    f = c.endContainer;
                    var o = c.startOffset, e = c.endOffset, k, l = this.guard, t = this.type, h = a ? "getPreviousSourceNode" : "getNextSourceNode";
                    if (!a && !this._.guardLTR) {
                        var r = f.type == CKEDITOR.NODE_ELEMENT ? f : f.getParent(), i = f.type == CKEDITOR.NODE_ELEMENT ? f.getChild(e) : f.getNext();
                    ...
                    if (a && !this._.guardRTL) {
                        var g = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(), j = d.type == CKEDITOR.NODE_ELEMENT ? o ? d.getChild(o - 1) : null : d.getPrevious();
                    ...
                    if (this.current)
                        ...
                        if (a)
                            ...
                            f = d;
                            if (f.type == CKEDITOR.NODE_ELEMENT && !(f = f.getChild(o)))
                                f = k(d, true) === false ? null : d.getNextSourceNode(true, t, k)
                        }
                        f && k(f) === false && (f = null)
                    }
                    for (; f && !this._.end; ) {
                ...
                var c = {block: 1, "list-item": 1, table: 1, "table-row-group": 1, "table-header-group": 1, "table-footer-group": 1, "table-row": 1, "table-column-group": 1, "table-column": 1, "table-cell": 1, "table-caption": 1}, d = {absolute: 1,
                    fixed: 1};
                ...
                var h = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, g = CKEDITOR.dom.walker.whitespaces(), n = CKEDITOR.dom.walker.bookmark(), i = CKEDITOR.dom.walker.temp();
                ...
                CKEDITOR.dom.element.prototype.getBogus = function () {
                    ...
                    while (n(a) || g(a) || a.type == CKEDITOR.NODE_ELEMENT && a.is(CKEDITOR.dtd.$inline) && !a.is(CKEDITOR.dtd.$empty));
            ...
            (function () {
                ...
                var c = function (a) {
                    ...
                    for (var g = c, j, n, E, z = t; z < h.length; z++) {
                        ...
                        for (j = j.getNext(); j; ) {
                            if (j.equals(m[z]) || j.equals(e))
                                break;
                            E = j.getNext();
                            if (b == 2)
                                g.append(j.clone(true));
                            else {
                                j.remove();
                                b == 1 && g.append(j)
                            }
                    ...
                    for (c = t; c < m.length; c++) {
                        ...
                        if (!h[c] || j.$.parentNode != h[c].$.parentNode)
                            for (j = j.getPrevious(); j; ) {
                                if (j.equals(h[c]) || j.equals(f))
                                    break;
                                E = j.getPrevious();
                                if (b == 2)
                                    g.$.insertBefore(j.$.cloneNode(true), g.$.firstChild);
                                else {
                                    j.remove();
                        ...
                        {clone: function () {
                                ...
                                function a(b) {
                                    ...
                                    if (c.type == CKEDITOR.NODE_TEXT) {
                                        f = c;
                                        for (e = 0; (f = f.getPrevious()) && f.type == CKEDITOR.NODE_TEXT; )
                                            e = e + f.getLength();
                                        d = d + e
                                    }
                                    b.container = c;
                                ...
                                return function (b) {
                                    var c = this.collapsed, d = {container: this.startContainer, offset: this.startOffset}, f = {container: this.endContainer, offset: this.endOffset};
                                    if (b) {
                                        a(d);
                                        c || a(f)
                                    }
                                    return{start: d.container.getAddress(b), end: c ? null : f.container.getAddress(b),
                            ...
                            getBoundaryNodes: function () {
                                ...
                                switch (a) {
                                    ...
                                    case CKEDITOR.ENLARGE_ELEMENT:
                                        ...
                                        for (k = c(k); k || l; ) {
                                            if (k && !l) {
                                                !t && k.equals(f) && (t = true);
                                                if (d ? k.isBlockBoundary() : !e.contains(k))
                                                    break;
                                            ...
                                            for (; l; ) {
                                                r = false;
                                                if (l.type == CKEDITOR.NODE_COMMENT)
                                                    l = l.getPrevious();
                                                else {
                                    ...
                                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                                        ...
                                        var z, M, Q = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null), v = null, w = function (a) {
                                ...
                                if (!this.collapsed) {
                                    var a = a || CKEDITOR.SHRINK_TEXT, d = this.clone(), f = this.startContainer, e = this.endContainer, h = this.startOffset, m = this.endOffset, k = 1, l = 1;
                                ...
                                var c = new CKEDITOR.dom.range(this.root), d = 0, f, e = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START];
            ...
            (function () {
                ...
                function e(a, b, c) {
                    for (a = a.getNextSourceNode(b, null, c); !h(a); )
                ...
                function c(a, d, e, h) {
                    ...
                    if (!h)
                        return 0;
                    if ((g = CKEDITOR.filter.instances[h.element.data("cke-filter")]) && !g.check(d))
                        return c(a, d, e, h.remaining);
                ...
                a.prototype = {getNextParagraph: function (a) {
                        ...
                        for (this._.nextNode = null; p; ) {
                            ...
                            if (k)
                                p.type == CKEDITOR.NODE_TEXT && d.test(p.getText()) && (k = 0);
                            else {
                                var t = p.getName();
                        ...
                        if (!b) {
                            ...
                            y = {div: 1, th: 1, td: 1};
                            b = b.block;
                            if (!b && p && !this.enforceRealBlocks && y[p.getName()] && g.checkStartOfBlock() && g.checkEndOfBlock() && !p.equals(g.root))
                                b = p;
                                ...
                                this._.nextNode = b.equals(f) ? null : e(g.getBoundaryNodes().endNode, 1, f)
                        }
                        if (s)
                            (s = b.getPrevious()) && s.type == CKEDITOR.NODE_ELEMENT && (s.getName() == "br" ? s.remove() : s.getLast() && s.getLast().$.nodeName.toLowerCase() == "br" && s.getLast().remove());
                        if (u)
                            (s = b.getLast()) && s.type == CKEDITOR.NODE_ELEMENT && s.getName() == "br" && (!CKEDITOR.env.needsBrFiller || s.getPrevious(h) || s.getNext(h)) && s.remove();
                        if (!this._.nextNode)
                            this._.nextNode = q || b.equals(f) || !f ? null : e(b, 1, f);
                        return b
                    }};
            ...
            (function () {
                    ...
                    if ((f || typeof a.elements != "function" || a.elements(m)) && (!a.match || a.match(b))) {
                        ...
                        if (!f) {
                            if (!a.propertiesOnly)
                                c.valid = true;
                            if (!c.allAttributes)
                                c.allAttributes = e(a.attributes, b.attributes, c.validAttributes);
                            if (!c.allStyles)
                                c.allStyles =
                ...
                function c(b) {
                    ...
                    return b._.filterFunction = function (f, e, k, m, l, h, t) {
                        ...
                        if (e) {
                            var g = f.name, k = e.elements[g], x = e.generic, e = {valid: false, validAttributes: {}, validClasses: {}, validStyles: {},
                ...
                var t = CKEDITOR.dtd, x = CKEDITOR.tools.copy, r = CKEDITOR.tools.trim, L = "cke-test", A = ["", "p", "br", "div"];
                ...
                CKEDITOR.filter.prototype = {allow: function (a, c, d) {
                        ...
                        if (this.disabled)
                            return false;
                        var k = [], m = !d && this._.rules, l = this._.transformations, h = c(this), p = this.editor && this.editor.config.protectedSource, g = false;
                        a.forEach(function (a) {
                            if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        k.length && (g = true);
                        for (var r, a = [], e = A[e || (this.editor ? this.editor.enterMode : CKEDITOR.ENTER_P)]; d = k.pop(); )
                            d.type == CKEDITOR.NODE_ELEMENT ? f(d, e, a) : d.remove();
                        for (; r = a.pop(); ) {
                            d = r.el;
                            if (d.parent)
                                switch (r.check) {
                        ...
                        if (typeof a == "string") {
                            ...
                            if (e)
                                f.attributes.style = CKEDITOR.tools.writeCssText(f.styles);
                            e = f
                        } else {
                            f = a.getDefinition();
                            e = f.styles;
                                ...
                                if (typeof b == "string")
                                    ...
                                    for (e in f)
                                        if (e ==
                                                "class") {
                                            c = a.classes.join("|");
                                            for (m = f[e].split(/\s+/); l = m.pop(); )
                                                c.indexOf(l) == -1 && a.classes.push(l)
                                        } else
                                            a.attributes[e] = f[e];
                                    for (k in d)
                                        a.styles[k] = d[k]
            ...
            (function () {
                CKEDITOR.lang = {languages: {af: 1, ar: 1, bg: 1, bn: 1, bs: 1, ca: 1, cs: 1, cy: 1, da: 1, de: 1, el: 1, "en-au": 1, "en-ca": 1, "en-gb": 1, en: 1, eo: 1, es: 1, et: 1, eu: 1, fa: 1, fi: 1, fo: 1, "fr-ca": 1, fr: 1, gl: 1, gu: 1, he: 1, hi: 1, hr: 1, hu: 1, id: 1, is: 1, it: 1, ja: 1, ka: 1, km: 1, ko: 1, ku: 1, lt: 1, lv: 1, mk: 1, mn: 1, ms: 1, nb: 1, nl: 1, no: 1, pl: 1, "pt-br": 1, pt: 1, ro: 1, ru: 1, si: 1, sk: 1, sl: 1, sq: 1, "sr-latn": 1, sr: 1, sv: 1, th: 1, tr: 1, ug: 1, uk: 1, vi: 1, "zh-cn": 1, zh: 1}, rtl: {ar: 1, fa: 1, he: 1, ku: 1, ug: 1}, load: function (a, e, b) {
                        ...
                        var b = this.languages, e = e || navigator.userLanguage || navigator.language || a, c = e.toLowerCase().match(/([a-z]+)(?:-([a-z]+))?/), d = c[1], c = c[2];
            ...
            CKEDITOR.scriptLoader = function () {
                ...
                return{load: function (b, c, d, h) {
                    ...
                    queue: function () {
                        ...
                        return function (d, e) {
                            var g = this;
                            c.push({scriptUrl: d, callback: function () {
                    ...
                    var h = {}, g = function (b) {
                        a.call(this, b, function (a) {
                            ...
                            for (n in a) {
                                ...
                                if (!e[n]) {
                                    if (q.icons)
                                        for (var u = q.icons.split(","), f = u.length; f--; )
                                            CKEDITOR.skin.addIcon(u[f], q.path + "icons/" + (CKEDITOR.env.hidpi && q.hidpi ? "hidpi/" : "") + u[f] + ".png");
                                    e[n] = 1
                                }
                                if (s) {
                                    s.split && (s = s.split(","));
                ...
                function a(a, c, h) {
                    ...
                    if (c !== void 0) {
                        ...
                        if (!(h == CKEDITOR.ELEMENT_MODE_INLINE ? c.is(CKEDITOR.dtd.$editable) || c.is("textarea") : h == CKEDITOR.ELEMENT_MODE_REPLACE ?
                                !c.is(CKEDITOR.dtd.$nonBodyContent) : 1))
                    ...
                    CKEDITOR.plugins.load(c.split(","), function (c) {
                        ...
                        for (var l in c) {
                            ...
                            if (g && !a.lang[l]) {
                                ...
                                if (!m.langEntries || !m.langEntries[i])
                                    k.push(CKEDITOR.getUrl(m.path + "lang/" + i + ".js"));
                                else {
                        ...
                        CKEDITOR.scriptLoader.load(k, function () {
                            ...
                            for (m = 0; m < a.config.blockedKeystrokes.length; m++)
                                a.keystrokeHandler.blockedKeystrokes[a.config.blockedKeystrokes[m]] = 1;
                            a.status = "loaded";
                            a.fireOnce("loaded");
            ...
            (function () {
                ...
                CKEDITOR.htmlParser.prototype = {onTagOpen: function () {
                        ...
                        if (b.length >
                                h)
                            this.onText(b.substring(h, b.length))
                    }}
            })();
            ...
            (function () {
                ...
                CKEDITOR.htmlParser.node.prototype = {remove: function () {
                        ...
                        var e = this.parent.children, b = CKEDITOR.tools.indexOf(e, this), c = a.previous = this.previous, d = a.next = this.next;
                        c && (c.next = a);
                        d && (d.previous = a);
                        e[b] = a;
            ...
            (function () {
                ...
                var e = CKEDITOR.tools.extend({table: 1, ul: 1, ol: 1, dl: 1}, CKEDITOR.dtd.table, CKEDITOR.dtd.ul, CKEDITOR.dtd.ol, CKEDITOR.dtd.dl), b = {ol: 1, ul: 1}, c = CKEDITOR.tools.extend({}, {html: 1}, CKEDITOR.dtd.html, CKEDITOR.dtd.body, CKEDITOR.dtd.head, {style: 1, script: 1});
                CKEDITOR.htmlParser.fragment.fromHtml = function (d, h, g) {
                    ...
                    var u = new CKEDITOR.htmlParser, f = h instanceof CKEDITOR.htmlParser.element ? h : typeof h == "string" ? new CKEDITOR.htmlParser.element(h) : new CKEDITOR.htmlParser.fragment, p = [], y = [], m = f, k = f.name == "textarea", l = f.name == "pre";
                                ...
                                for (; ; ) {
                                    ...
                                    if (!f.isUnknown && !m.isUnknown && !g[d])
                                        if (m.isOptionalClose)
                                            ...
                                            m = h
                                        } else if (d in CKEDITOR.dtd.$listItem && !s(d, h))
                                            u.onTagOpen(d ==
                                                    "li" ? "ul" : "dl", {}, 0, 1);
            ...
            (function () {
                ...
                a.prototype = {add: function (a, c, d) {
                        this.rules.splice(this.findIndex(c), 0, {value: a, priority: c, options: d})
                            ...
                            c, d) {
                        for (var e = [this.findIndex(c), 0], g = 0, n = a.length; g < n; g++)
                            e.push({value: a[g], priority: c, options: d});
                        ...
                        var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, e = Array.prototype.slice.call(arguments, 1), g = this.rules, n = g.length, i, j, o, q;
                        for (q = 0; q < n; q++) {
                            if (d) {
                                i = c.type;
                                j = c.name
                            ...
                            if (!a.nonEditable || o.options.applyToAll) {
                                ...
                                if (o === false || d && o && (o.name != j || o.type != i))
                                    return o;
                                o != void 0 && (e[0] = c = o)
                            }
                        }
                        ...
                        for (var d = 0, e = this.rules, g = e.length, n; c && d < g; d++) {
                            ...
                            if (!a.nonEditable || n.options.applyToAll)
                                c = c.replace(n.value[0], n.value[1])
                        }
                        return c
                    }}
            })();
            (function () {
                function a(a, e) {
                        ...
                        return function (e) {
                            if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                                ...
                                if (k = CKEDITOR.env.opera && !a || (typeof d == "function" ? d(e) !==
                                        false : d))
                                    if (!v && !CKEDITOR.env.needsBrFiller && e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT)
                                        k = false;
                                    else if (!v && !CKEDITOR.env.needsBrFiller && (document.documentMode > 7 || e.name in CKEDITOR.dtd.tr || e.name in CKEDITOR.dtd.$listItem))
                                        k = false;
                                    else {
                                        k = b(e);
                    ...
                    function m(a, b) {
                        if ((!v || CKEDITOR.env.needsBrFiller) && a.type == CKEDITOR.NODE_ELEMENT && a.name == "br" && !a.attributes["data-cke-eol"])
                            return true;
                        var c;
                        if (a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(y))) {
                            ...
                            if (!CKEDITOR.env.needsBrFiller && v && (!b || a.parent.name in i))
                                return true;
                            if (!v)
                                if ((c = a.previous) && c.name == "br" || !c || h(c))
                                    return true
                        }
                        return false
                    }
                    ...
                    for (p in i)
                        "#"in k[p] || delete i[p];
                    for (p in i)
                        r.elements[p] = l(v, a.config.fillEmptyBlocks !== false);
                    r.root = l(v);
                ...
                var y = /(?:&nbsp;|\xa0)$/, m = "{cke_protected}", k = CKEDITOR.dtd, l = ["caption", "colgroup", "col", "thead", "tfoot",
                    "tbody"], t = CKEDITOR.tools.extend({}, k.$blockLimit, k.$block), x = {elements: {input: n, textarea: n}}, r = {attributeNames: [[/^on/, "data-cke-pa-on"], [/^data-cke-expando$/, ""]]}, L = {elements: {embed: function (a) {
                            var b = a.parent;
                            if (b && b.name == "object") {
                            ...
                            if (!a.children.length && !a.attributes.name && !a.attributes["data-cke-saved-name"])
                                return false
                        }}}, A = {elementNames: [[/^cke:/, ""], [/^\?xml:namespace$/, ""]],
                    attributeNames: [[/^data-cke-(saved|pa)-/, ""], [/^data-cke-.*/, ""], ["hidefocus", ""]], elements: {$: function (a) {
                            var b = a.attributes;
                            if (b) {
                                if (b["data-cke-temp"])
                                    return false;
                        ...
                        }, input: i, textarea: i}, attributes: {"class": function (a) {
                ...
                var I = /<(a|area|img|input|source)\b([^>]*)>/gi, E = /\s(on\w+|href|src|name)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, z = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
            ...
            (function () {
                ...
                CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
                        ...
                        for (var b = this.children.splice(a, this.children.length - a), e = this.clone(), g = 0; g < b.length; ++g)
                            b[g].parent = e;
                        e.children = b;
                        if (b[0])
                            b[0].previous = null;
                        ...
                        if (b)
                            (b = CKEDITOR.tools.trim(b.replace(RegExp("(?:\\s+|^)" + a +
                        ...
                        if (b.length)
                            for (var a = CKEDITOR.tools.copy(a), e = 0; e < b.length; e = e + 2)
                                a[b[e]] = b[e +
                                        1];
                        return a
                    }}, true)
            ...
            (function () {
                ...
                function b(a) {
                    var b = a.name, e = a.element, n = a.elementMode,
                            i = a.fire("uiSpace", {space: "top", html: ""}).html, j = a.fire("uiSpace", {space: "bottom", html: ""}).html;
                    ...
                    b = CKEDITOR.dom.element.createFromHtml(c.output({id: a.id, name: b, langDir: a.lang.dir, langCode: a.langCode, voiceLabel: [a.lang.editor, a.name].join(", "), topHtml: i ? '<span id="' + a.ui.spaceId("top") + '" class="cke_top cke_reset_all" role="presentation" style="height:auto">' + i + "</span>" : "", contentId: a.ui.spaceId("contents"), bottomHtml: j ? '<span id="' + a.ui.spaceId("bottom") + '" class="cke_bottom cke_reset_all" role="presentation">' + j + "</span>" : "", outerEl: CKEDITOR.env.ie ? "span" : "div"}));
                    if (n == CKEDITOR.ELEMENT_MODE_REPLACE) {
                        e.hide();
                        b.insertAfter(e)
                    } else
            ...
            (function () {
                ...
                function e(a, b) {
                    ...
                    if (e && e.isBlockBoundary() && (!d || !(d.type == CKEDITOR.NODE_ELEMENT &&
                            d.isBlockBoundary())) && !e.is("pre") && !e.getBogus())
                        return e
                }
                function b(a) {
                ...
                CKEDITOR.editable = CKEDITOR.tools.createClass({base: CKEDITOR.dom.element, $: function (a, b) {
                        ...
                        this.setup()
                            ...
                            g(this);
                            var b = this.editor, c = b.getSelection().getStartElement().hasAscendant("pre", true) ? CKEDITOR.ENTER_BR : b.activeEnterMode, b = c == CKEDITOR.ENTER_BR, e = CKEDITOR.tools, a = e.htmlEncode(a.replace(/\r\n/g, "\n")), a = a.replace(/\t/g, "&nbsp;&nbsp; &nbsp;"), c = c == CKEDITOR.ENTER_P ? "p" : "div";
                            if (!b) {
                                var d = /\n{2}/g;
                                if (d.test(a))
                                    var l = "<" + c + ">", h = "</" + c + ">", a = l + a.replace(d, function () {
                                    return h + l
                                }) + h
                            }
                            a = a.replace(/\n/g, "<br>");
                            ...
                            if (b.checkReadOnly())
                                return false;
                            b.deleteContents(1);
                            b.startContainer.type == CKEDITOR.NODE_ELEMENT && b.startContainer.is({tr: 1, table: 1, tbody: 1, thead: 1, tfoot: 1}) && u(b);
                            var g, h;
                            if (l)
                                for (; (g = b.getCommonAncestor(0, 1)) && (h = CKEDITOR.dtd[g.getName()]) && (!h || !h[d]); )
                                    if (g.getName()in CKEDITOR.dtd.span)
                                        ...
                                        b.splitBlock(e == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
                            b.insertNode(a);
                            return true
                        }, insertElementIntoSelection: function (a) {
                            var b = this.editor, e = b.activeEnterMode, b = b.getSelection(), d = b.getRanges()[0], k = a.getName(), k = CKEDITOR.dtd.$block[k];
                            g(this);
                            if (this.insertElementIntoRange(a, d)) {
                                ...
                                if (k)
                                    if ((k = a.getNext(function (a) {
                                        return c(a) && !i(a)
                                    })) && k.type == CKEDITOR.NODE_ELEMENT && k.is(CKEDITOR.dtd.$block))
                                        k.getDtd()["#"] ? d.moveToElementEditStart(k) : d.moveToElementEditEnd(a);
                        ...
                        setup: function () {
                            ...
                            if (!this.is("textarea")) {
                                ...
                                this.attachListener(a, "key", function (b) {
                                    ...
                                    if (c in k) {
                                        var b = a.getSelection(), d, m = b.getRanges()[0], g = m.startPath(), i, j, n, c = c == 8;
                                        if (CKEDITOR.env.ie && CKEDITOR.env.version < 11 && (d = b.getSelectedElement()) || (d = h(b))) {
                                            ...
                                            if ((i = g.block) && (n = i[c ? "getPrevious" : "getNext"](o)) && n.type == CKEDITOR.NODE_ELEMENT && n.is("table") &&
                                                ...
                                                a.fire("saveSnapshot");
                                                e = 1
                                            } else if ((j = g.contains(["td", "th", "caption"])) && m.checkBoundaryOfElement(j, c ? CKEDITOR.START : CKEDITOR.END))
                                                e = 1
                                    }
                                    return!e
                                });
                ...
                var i = CKEDITOR.dom.walker.bogus(), j = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi,
                ...
                var s = function () {
                        ...
                        for (var i = g[i.getName()], r = 0, j = c.getChildren(), n = j.count(), o = -1, q = -1, x = 0, s = d.contains(g.$list); r < n; ++r) {
                            ...
                            if (a(d)) {
                                ...
                                if (s && m in CKEDITOR.dtd.$list)
                                    ...
                                    o == -1 && !l && (o = r);
                                    l || (q = r);
                                    h.push({isElement: 1, isLineBreak: x, isBlock: d.isBlockBoundary(), hasBlockSibling: k, node: d, name: m, allowed: l});
                                    k = x = 0
                                }
                            } else
                                h.push({isElement: 0, node: d, allowed: 1})
                        }
                        if (o > -1)
                            h[o].firstNotAllowed = 1;
                        if (q > -1)
                            h[q].lastNotAllowed = 1;
                        return h
                    }
                    function e(b, c) {
                    ...
                    var g = CKEDITOR.dtd, h = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1}, r = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, i = CKEDITOR.tools.extend({}, g.$inline);
                    delete i.br;
                    return function (h,
                            j, o) {
                        var q = h.editor;
                        ...
                        if (!x.checkReadOnly()) {
                            var v = (new CKEDITOR.dom.elementPath(x.startContainer, x.root)).blockLimit || x.root, j = {type: j, dontFilter: s, editable: h, editor: q, range: x, blockLimit: v, mergeCandidates: [], zombies: []}, q = j.range, s = j.mergeCandidates, w, H, C, D;
                            ...
                            for (; (D = a(q.startContainer) && q.startContainer.getChild(q.startOffset - 1)) && a(D) && D.isBlockBoundary() && H.contains(D); )
                                q.moveToPosition(D, CKEDITOR.POSITION_BEFORE_END);
                            ...
                            for (v = w.startNode; (v = v.getParent()) && d(v); )
                                s.push(v);
                            q.moveToBookmark(w);
                            if (w = o) {
                                w = j.range;
                                ...
                                if (/^\s+|\s+$/.test(o) && "span"in CKEDITOR.dtd[D])
                                    var u = '<span data-cke-marker="1">&nbsp;</span>', o = u + o + u;
                                o = j.editor.dataProcessor.toHtml(o, {context: null, fixForBody: false, dontFilter: j.dontFilter, filter: j.editor.activeFilter, enterMode: j.editor.activeEnterMode});
                                ...
                                if ((u = w.startPath().block) && !(u.getChildCount() == 1 && u.getBogus()))
                                    a:{
                                        var F;
                                    ...
                                    if (B = C.isLineBreak) {
                                        ...
                                        if (C.hasBlockSibling)
                                            ...
                                            if (!N || !N.is({div: 1, p: 1}))
                                                ...
                                                U = N.getPosition(K);
                                                if (U == CKEDITOR.POSITION_IDENTICAL || U == CKEDITOR.POSITION_CONTAINS)
                                                    B = 0;
                                                else {
                                                    K = B.splitElement(N);
                            ...
                            if (R)
                                for (; G = R.pop(); )
                                    CKEDITOR.env.needsBrFiller ? G.appendBogus() : G.append(J.document.createText(" "));
                            for (; G = j.mergeCandidates.pop(); )
                                G.mergeSiblings();
                            J.moveToBookmark(S);
                            if (!j.dontMoveCaret) {
                                for (G = a(J.startContainer) && J.startContainer.getChild(J.startOffset - 1); G && a(G) && !G.is(g.$empty); ) {
                                    if (G.isBlockBoundary())
                                        J.moveToPosition(G,
                                                CKEDITOR.POSITION_BEFORE_END);
                                    else {
            ...
            (function () {
                ...
                function n(a, b, c) {
                    ...
                    if (CKEDITOR.env.ie)
                        var d = a.getDocument().on("selectionchange", function (a) {
                            a.cancel()
                        }, null, null, -100);
                    else {
                ...
                var o, q, s = CKEDITOR.dom.walker.invisible(1), u = function () {
                    ...
                    function b(a) {
                        return function (b) {
                            ...
                            if (!(d = e.moveToClosestEditablePosition(b.selected, a)))
                                d = e.moveToClosestEditablePosition(b.selected, !a);
                ...
                CKEDITOR.on("instanceCreated", function (b) {
                    ...
                    d.on("contentDom", function () {
                        var b = d.document, c = CKEDITOR.document, k = d.editable(), m = b.getBody(), g = b.getDocumentElement(), i = k.isInline(), o, n;
                        ...
                        if (i ? CKEDITOR.env.webkit || CKEDITOR.env.gecko : CKEDITOR.env.opera) {
                            ...
                            k.attachListener(CKEDITOR.env.ie ? k : b.getDocumentElement(), "mouseup", e, d);
                        CKEDITOR.env.webkit &&
                    ...
                    d.on("key", function (a) {
                        if (d.mode == "wysiwyg") {
                            ...
                            if (b.isFake) {
                                ...
                                if (c)
                                    return c({editor: d, selected: b.getSelectedElement(), selection: b, keyEvent: a})
                            }
                        }
                    })
                });
                ...
                CKEDITOR.dom.selection = function (a) {
                    ...
                    if (CKEDITOR.env.webkit)
                        (b.type == "None" && this.document.getActive().equals(a) || b.type == "Caret" && b.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && n(a, b);
                    else if (CKEDITOR.env.gecko)
                        b && (this.document.getActive().equals(a) && b.anchorNode && b.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && n(a, b, true);
                        ...
                        if (f)
                            b.type == "None" && (d && d.equals(this.document.getDocumentElement())) && n(a, null, true);
                        else {
                    ...
                    if (d)
                        if (d.getRangeAt)
                            g = (h = d.rangeCount && d.getRangeAt(0)) && new CKEDITOR.dom.node(h.commonAncestorContainer);
                        else {
                            try {
                                h = d.createRange()
                            } catch (j) {
                        ...
                        {getNative: function () {
                                ...
                                var a = f ? function () {
                                    ...
                                    var b = function (b, c) {
                                        ...
                                        h = h.text.replace(/(\r\n|\r)/g, "\n").length;
                                        if (!h)
                                            return{container: d, offset: a(f) + (i > 0 ? 0 : 1)};
                                        for (; h > 0; )
                                            try {
                                            ...
                                            if (!f.collapsed) {
                                                if (f.startContainer.isReadOnly())
                                                    for (var b = f.startContainer, g; b; ) {
                                                        if ((g = b.type == CKEDITOR.NODE_ELEMENT) && b.is("body") || !b.isReadOnly())
                                                            break;
                                ...
                                var b = this, c = CKEDITOR.tools.tryThese(function () {
                                    return b.getNative().createRange().item(0)
                                        ...
                                        function () {
                                            for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && (!(c = a.getEnclosedNode()) || !(c.type == CKEDITOR.NODE_ELEMENT && y[c.getName()] && (d = c))); e--)
                                        ...
                                        if (b)
                                            ...
                                            if (f) {
                                                ...
                                                if (n && n.type == CKEDITOR.NODE_ELEMENT &&
                                                        n.getName()in y && (!n.is("a") || !n.getText()))
                                                    try {
                                                ...
                                                for (o = 0; o < a.length; o++) {
                                                    ...
                                                    if (b.collapsed && CKEDITOR.env.webkit && c(b)) {
                                                        ...
                                                        if ((j = d.getNext()) && !d.getPrevious() && j.type == CKEDITOR.NODE_ELEMENT && j.getName() == "br") {
                                                            ...
                                                            b.moveToPosition(d, CKEDITOR.POSITION_AFTER_END)
                                                    }
            ...
            (function () {
                    ...
                    if (b.collapsed) {
                        ...
                        for (n.getPosition(o) == CKEDITOR.POSITION_FOLLOWING && (n = 0); n; ) {
                            ...
                            if (n.equals(o)) {
                                ...
                                var s = n.type == CKEDITOR.NODE_ELEMENT ? n.getName() : null, p = s && n.getAttribute("contentEditable") == "false", r = s && n.getAttribute("data-nostyle");
                                ...
                                if (x)
                                    if ((x = n.getParent()) && ((x.getDtd() || CKEDITOR.dtd.span)[f] || h) && (!g.parentRule || g.parentRule(x))) {
                                        ...
                                        if (s == CKEDITOR.NODE_TEXT || p || s == CKEDITOR.NODE_ELEMENT && !n.getChildCount()) {
                                            for (var s = n, W; (j = !s.getNext(E)) && (W = s.getParent(), k[W.getName()]) && (W.getPosition(m) | Q) == Q && (!g.childRule || g.childRule(W)); )
                                                s = W;
                                            q.setEndAfter(s)
                                        }
                                    } else
                                ...
                                for (var j = y(this, d), p = j.hasAttributes(), r = q.getCommonAncestor(), s = {}, x = {}, z = {}, A = {}, T, P, Z; j && r; ) {
                                    if (r.getName() == f) {
                                        for (T in g.attributes)
                                            if (!A[T] &&
                                                    (Z = r.getAttribute(P)))
                                                j.getAttribute(T) == Z ? x[T] = 1 : A[T] = 1;
                                        for (P in g.styles)
                                            if (!z[P] && (Z = r.getStyle(P)))
                                                j.getStyle(P) == Z ? s[P] = 1 : z[P] = 1
                                    }
                                    r = r.getParent()
                                }
                                for (T in x)
                ...
                function i(a, b) {
                    ...
                    if (d && !e) {
                        ...
                        f ? b = q(c ? [a.getHtml()] : j(a), b) : a.moveChildren(b);
                    b.replace(a);
                    if (d) {
                        var c = b, h;
                ...
                function s(a, b) {
                    var c = this._.definition,
                            d = c.attributes, c = c.styles, e = l(this)[a.getName()], g = CKEDITOR.tools.isEmpty(d) && CKEDITOR.tools.isEmpty(c), h;
                    for (h in d)
                ...
                var r = {address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1, keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1}, L = {a: 1,
                    embed: 1, hr: 1, img: 1, li: 1, object: 1, ol: 1, table: 1, td: 1, tr: 1, th: 1, ul: 1, dl: 1, dt: 1, dd: 1, form: 1, audio: 1, video: 1}, A = /\s*(?:;\s*|$)/, I = /#\((.+?)\)/g, E = CKEDITOR.dom.walker.bookmark(0, 1), z = CKEDITOR.dom.walker.whitespaces(1);
            ...
            CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {type: CKEDITOR.NODE_TEXT, getLength: function () {
                    ...
                    var e = this.$.parentNode, b = e.childNodes.length, c = this.getLength(), d = this.getDocument(), h = new CKEDITOR.dom.text(this.$.splitText(a), d);
            ...
            (function () {
                function a(a, c, d) {
                    var e = a.serializable, g = c[d ? "endContainer" : "startContainer"], n = d ? "endOffset" : "startOffset", i = e ? c.document.getById(a.startNode) : a.startNode, a = e ? c.document.getById(a.endNode) : a.endNode;
                                ...
                                if (n && a.length > 1) {
                                    if (!e)
                                        for (var i = a.length - 1; i >= 0; i--)
                                            d.unshift(a[i].createBookmark(true));
                                    if (g)
                                        for (var j = 0; a[e + j + 1]; ) {
                ...
                function e(b) {
                    ...
                    if (c)
                        for (var c = c.split(",").sort(function (a, b) {
                            ...
                            g = c[e];
                            if (d.ie && (g.replace(/^ie/, "") == d.version || d.quirks && g == "iequirks"))
                                g = "ie";
                            if (d[g]) {
                                b = b + ("_" + c[e]);
                                break
            ...
            CKEDITOR.plugins.add("dialogui", {onLoad: function () {
                    ...
                    CKEDITOR.tools.extend(CKEDITOR.ui.dialog, {labeledElement: function (b, a, d, e) {
                                ...
                                CKEDITOR.ui.dialog.uiElement.call(this, b, a, d, "div", null, {role: "presentation"}, function () {
                                    ...
                                    "horizontal" !=
                                            a.labelLayout ? f.push('<label class="cke_dialog_ui_labeled_label' + d + '" ', ' id="' + c.labelId + '"', c.inputId ? ' for="' + c.inputId + '"' : "", (a.labelStyle ? ' style="' + a.labelStyle + '"' : "") + ">", a.label, "</label>", '<div class="cke_dialog_ui_labeled_content"', a.controlStyle ? ' style="' + a.controlStyle + '"' : "", ' role="radiogroup" aria-labelledby="' + c.labelId + '">', e.call(this, b, a), "</div>") : (d = {type: "hbox", widths: a.widths, padding: 0, children: [{type: "html", html: '<label class="cke_dialog_ui_labeled_label' + d + '" id="' + c.labelId +
                                                        '" for="' + c.inputId + '"' + (a.labelStyle ? ' style="' + a.labelStyle + '"' : "") + ">" + CKEDITOR.tools.htmlEncode(a.label) + "</span>"}, {type: "html", html: '<span class="cke_dialog_ui_labeled_content"' + (a.controlStyle ? ' style="' + a.controlStyle + '"' : "") + ">" + e.call(this, b, a) + "</span>"}]}, CKEDITOR.dialog._.uiElementBuilders.hbox.build(b, d, f));
                                    return f.join("")
                                })
                            }
                            ...
                            if (!(3 > arguments.length)) {
                                i.call(this, a);
                                var e = this._.inputId = CKEDITOR.tools.getNextId() + "_textInput", c = {"class": "cke_dialog_ui_input_" +
                            ...
                            if (arguments.length) {
                                ...
                                CKEDITOR.ui.dialog.uiElement.call(this, b, c, d, "a", null, {style: a.style, href: "javascript:void(0)", title: a.label, hidefocus: "true", "class": a["class"], role: "button", "aria-labelledby": f}, '<span id="' + f +
            ...
            (function () {
                ...
                CKEDITOR.dialog = function (a, b) {
                    ...
                    function d(b) {
                        if (m ==
                            ...
                            if (9 == c || c == CKEDITOR.SHIFT + 9)
                                c = c == CKEDITOR.SHIFT + 9, m._.tabBarMode ? (c = c ? t.call(m) : u.call(m), m.selectPage(c), m._.tabs[c][0].focus()) : e(c ? -1 : 1), o = 1;
                            else if (c == CKEDITOR.ALT + 121 && !m._.tabBarMode && 1 < m.getPageCount())
                                m._.tabBarMode = !0, m._.tabs[m._.currentTabId][0].focus(), o = 1;
                            else if ((37 == c || 39 == c) && m._.tabBarMode)
                                c = c == (d ? 39 : 37) ? t.call(m) : u.call(m), m.selectPage(c), m._.tabs[c][0].focus(), o = 1;
                    ...
                    this.on("cancel", function (b) {
                        p(function (c) {
                            if (c.isChanged())
                                return!a.config.dialog_noConfirmCancel && !confirm(a.lang.common.confirmCancel) &&
                                        (b.data.hide = !1), !0
                        })
                    }, this, null, 0);
                    ...
                    this.on("show", function () {
                        c();
                        if (a.config.dialog_startupFocusTab && 1 < m._.pageCount)
                            m._.tabBarMode = !0, m._.tabs[m._.currentTabId][0].focus();
                ...
                CKEDITOR.dialog.prototype = {destroy: function () {
                        ...
                        return function (a, b) {
                            if (!this._.contentSize || !(this._.contentSize.width == a && this._.contentSize.height == b))
                                CKEDITOR.dialog.fire("resize", {dialog: this, width: a, height: b}, this._.editor), this.fire("resize", {width: a, height: b}, this._.editor),
                        ...
                        if (!g || !this._.position || !(this._.position.x == a && this._.position.y == b))
                            this._.position = {x: a, y: b}, g || (g = CKEDITOR.document.getWindow().getScrollPosition(), a += g.x, b += g.y), d && (g = this.getSize(), a = CKEDITOR.document.getWindow().getViewPaneSize().width - g.width - a), b = {top: (0 < b ? b : 0) + "px"}, b[d ? "right" : "left"] = (0 < a ? a : 0) + "px", e.setStyles(b), c && (this._.moved = 1)
                    ...
                    setupContent: function () {
                        ...
                        if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
                            for (var b = [], c = a.label ? ' title="' + CKEDITOR.tools.htmlEncode(a.label) + '"' : "", e = CKEDITOR.dialog._.uiElementBuilders.vbox.build(this, {type: "vbox", className: "cke_dialog_page_contents", children: a.elements, expand: !!a.expand, padding: a.padding,
                                style: a.style || "width: 100%;"}, b), d = this._.contents[a.id] = {}, g = e.getChild(), f = 0; e = g.shift(); )
                ...
                var F, w = {}, q, s = {}, M = function (a) {
                    ...
                    if ((b = s[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (e ? "SHIFT+" : "") + d]) && b.length)
                        b = b[b.length - 1], b.keyup && (b.keyup.call(b.uiElement, b.dialog, b.key),
                                a.data.preventDefault())
                ...
                (function () {
                    CKEDITOR.ui.dialog = {uiElement: function (a, b, c, e, d, g, f) {
                            if (!(4 > arguments.length)) {
                                ...
                                for (var m = h["class"] && h["class"].split ? h["class"].split(" ") : [], j = 0; j < m.length; j++)
                                    m[j] && (n[m[j]] = 1);
                                m = [];
                                for (j in n)
                                    m.push(j);
                                ...
                                for (j in h)
                                    l.push(j + '="' + CKEDITOR.tools.htmlEncode(h[j]) + '" ');
                                l.push(">", o, "</", i, ">");
                                c.push(l.join(""));
                ...
                CKEDITOR.ui.dialog.uiElement.prototype = {getElement: function () {
                        ...
                        for (d in a)
                            if (c = d.match(b))
                                this.eventProcessors[d] ? this.eventProcessors[d].call(this, this._.dialog, a[d]) : e(this, this._.dialog,
                                        c[1].toLowerCase(), a[d]);
                        return this
                ...
                CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {openDialog: function (a, b) {
                        ...
                        if ("function" == typeof e)
                            c = this._.storedDialogs || (this._.storedDialogs = {}), c = c[a] || (c[a] = new CKEDITOR.dialog(this, a)), b && b.call(c,
                                    c), c.show();
                        else {
                            if ("failed" == e)
            ...
            CKEDITOR.plugins.add("dialog", {requires: "dialogui", init: function (t) {
            ...
            (function () {
                function w(b) {
                    ...
                    function k(a, d) {
                        ...
                        if (!c.getById("cke_pastebin")) {
                            ...
                            setTimeout(function () {
                                ...
                                j.remove();
                                var a;
                                if (CKEDITOR.env.webkit && (a = j.getFirst()) && a.is && a.hasClass("Apple-style-span"))
                                    j = a;
                    ...
                    function o() {
                        if (CKEDITOR.env.ie) {
                            ...
                            a.lock();
                            if (b.editable().fire(q) && !l("paste"))
                                return a.unlock(), !1;
                            a.unlock()
                        } else
                            try {
                                if (b.editable().fire(q) && !b.document.$.execCommand("Paste", !1, null))
                                    throw 0;
                            } catch (d) {
                                return!1
                            }
                ...
                function y(b, a) {
                    ...
                    if ((CKEDITOR.env.gecko || CKEDITOR.env.opera) && b.enterMode != CKEDITOR.ENTER_BR)
                        CKEDITOR.env.gecko && (a = a.replace(/^<br><br>$/, "<br>")), -1 < a.indexOf("<br><br>") && (a = "<p>" + a.replace(/(<br>){2,}/g, function (a) {
                            return c(a.length / 4)
                        }) + "</p>");
                    return p(b, a)
                }
                function z() {
                    var b = new CKEDITOR.htmlParser.filter, a = {blockquote: 1, dl: 1, fieldset: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ol: 1, p: 1, table: 1, ul: 1}, c = CKEDITOR.tools.extend({br: 0}, CKEDITOR.dtd.$inline), d =
                            {p: 1, br: 1, "cke:br": 1}, f = CKEDITOR.dtd, h = CKEDITOR.tools.extend({area: 1, basefont: 1, embed: 1, iframe: 1, map: 1, object: 1, param: 1}, CKEDITOR.dtd.$nonBodyContent, CKEDITOR.dtd.$cdata), l = function (a) {
                        delete a.name;
            ...
            CKEDITOR.plugins.add("contextmenu", {requires: "menu", onLoad: function () {
                    CKEDITOR.plugins.contextMenu = CKEDITOR.tools.createClass({base: CKEDITOR.menu, $: function (a) {
                        ...
                        }, proto: {addTarget: function (a, c) {
                                a.on("contextmenu", function (a) {
                                    var a = a.data, b = CKEDITOR.env.webkit ? d : CKEDITOR.env.mac ? a.$.metaKey : a.$.ctrlKey;
                                    if (!c || !b) {
                                        a.preventDefault();
                                        var e = a.getTarget().getDocument(), f = a.getTarget().getDocument().getDocumentElement(),
                                                b = !e.equals(CKEDITOR.document), e = e.getWindow().getScrollPosition(), g = b ? a.$.clientX : a.$.pageX || e.x + a.$.clientX, h = b ? a.$.clientY : a.$.pageY || e.y + a.$.clientY;
                                        CKEDITOR.tools.setTimeout(function () {
            ...
            (function () {
                ...
                CKEDITOR.ui.button.prototype = {render: function (a, b) {
                        ...
                        c = {id: i, name: g, iconName: h, label: this.label, cls: this.className || "", state: f, ariaDisabled: "disabled" == f ? "true" : "false", title: this.title, titleJs: c.gecko &&
            ...
            (function () {
                ...
                function n(a, c) {
                    ...
                    a.on("selectionChange", function () {
                        ...
                        e = e.length;
                        for (b = 0; b < e; b++)
                            f = g[b], c = a.lang.elementspath.eleTitle.replace(/%1/, f), f = v.output({id: n + b, label: c, text: f, jsTitle: "javascript:void('" + f + "')", index: b, keyDownFn: u, clickFn: t}), d.unshift(f);
                ...
                CKEDITOR.plugins.enterkey = {enterBlock: function (e, c, b, i) {
                        if (b = b || q(e)) {
                            ...
                            if (j && h) {
                                if (a && (a.is("li") || a.getParent().is("li"))) {
                                    ...
                                    if (d.is("li"))
                                        ...
                                        if (e)
                                            if (d = f.createElement(c == CKEDITOR.ENTER_P ? "p" : "div"), l && d.setAttribute("dir", j), n && d.setAttribute("style", n), h && d.setAttribute("class", h), a.moveChildren(d), i || m)
                                                d[i ?
                            ...
                            if (h = b.splitBlock(k)) {
                                ...
                                if (!e && !j)
                                    a.is("li") && (d = b.clone(), d.selectNodeContents(a), d = new CKEDITOR.dom.walker(d), d.evaluator = function (a) {
                                        return!(u(a) ||
                ...
                CKEDITOR.on("dialogDefinition", function (a) {
                    if (a.editor.plugins.filebrowser)
                        for (var c = a.data.definition, d, b = 0; b < c.contents.length; ++b)
                            if (d = c.contents[b])
                                j(a.editor, a.data.name, c, d.elements),
            ...
            CKEDITOR.plugins.add("richcombo", {requires: "floatpanel,listblock,button", beforeInit: function (d) {
            ...
            (function () {
                ...
                var d = d + (' onkeydown="return CKEDITOR.tools.callFunction({keydownFn},event,this);" onmousedown="return CKEDITOR.tools.callFunction({mousedownFn},event);"  onfocus="return CKEDITOR.tools.callFunction({focusFn},event);" ' + (CKEDITOR.env.ie ? 'onclick="return false;" onmouseup' : "onclick") + '="CKEDITOR.tools.callFunction({clickFn},this);return false;"><span id="{id}_text" class="cke_combo_text cke_combo_inlinelabel">{label}</span><span class="cke_combo_open"><span class="cke_combo_arrow">' +
                        (CKEDITOR.env.hc ? "&#9660;" : CKEDITOR.env.air ? "&nbsp;" : "") + "</span></span></a></span>"), i = CKEDITOR.addTemplate("combo", d);
                        ...
                        this._ = {panelDefinition: a, items: {}}
                            ...
                            var d = CKEDITOR.env, h = "cke_" + this.id, e = CKEDITOR.tools.addFunction(function (b) {
                                j && (a.unlockSelection(1),
                                        j = 0);
                                c.execute(b)
                            }, this), f = this, c = {id: h, combo: this, focus: function () {
                            ...
                            c.keyDownFn = k;
                            d = {id: h, name: this.name || this.command,
            ...
            (function () {
                ...
                var i = CKEDITOR.htmlParser.cssStyle, h = CKEDITOR.tools.cssLength, j = /^((?:\d*(?:\.\d+))|(?:\d+))(.*)?$/i, l = {elements: {$: function (a) {
                            ...
                            return b
                        }}}, k = CKEDITOR.plugins.add("fakeobjects", {init: function (a) {
            ...
            (function () {
                function E(c, k, e) {
                    function b(b) {
                        if ((d = a[b ? "getFirst" : "getLast"]()) && (!d.is || !d.isBlockBoundary()) && (m = k.root[b ? "getPrevious" : "getNext"](CKEDITOR.dom.walker.invisible(!0))) && (!m.is || !m.isBlockBoundary({br: 1})))
                    ...
                    for (h = 0; h < g.length; h++)
                        f = g[h].getCustomData("listarray_index"), j[f].indent = -1;
                    for (h = f + 1; h < j.length; h++)
                        if (j[h].indent > j[h - 1].indent + 1) {
                            g = j[h - 1].indent + 1 - j[h].indent;
                            for (f = j[h].indent; j[h] && j[h].indent >= f; )
                                j[h].indent += g, h++;
                            h--
                        }
                ...
                function A(c, k, e, b) {
                    for (var j, g; j = c[b?"getLast":"getFirst"](F); )
                        (g = j.getDirection(1)) !== k.getDirection(1) && j.setAttribute("dir", g), j.remove(), e ? j[b ? "insertBefore" : "insertAfter"](e) : k.append(j, b)
                }
                function B(c) {
                    var k;
                    (k = function (e) {
                ...
                var r = {ol: 1, ul: 1}, G = CKEDITOR.dom.walker.whitespaces(), D = CKEDITOR.dom.walker.bookmark(), q = function (c) {
                    return!(G(c) || D(c))
                        ...
                        for (var g = 0, h = c.getChildCount(); g < h; g++) {
                            ...
                            if ("li" == f.$.nodeName.toLowerCase()) {
                                ...
                                for (var d = 0, m = f.getChildCount(), i; d < m; d++)
                                    i = f.getChild(d), i.type == CKEDITOR.NODE_ELEMENT && r[i.getName()] ? CKEDITOR.plugins.list.listToArray(i, k, e, b + 1, a.grandparent) : a.contents.push(i)
                            }
                        }
                        return e
                        ...
                        for (var g, h = c[e].parent.getDocument(), f = new CKEDITOR.dom.documentFragment(h), a = null, d = e, m = Math.max(c[e].indent, 0), i = null, n, l, p = b == CKEDITOR.ENTER_P ? "p" : "div"; ; ) {
                            ...
                            if (o.indent == m) {
                                if (!a || c[d].parent.getName() != a.getName())
                                    a = c[d].parent.clone(!1, 1), j && a.setAttribute("dir", j), f.append(a);
                                ...
                                o = c[d - 1].element.getDirection(1), d = CKEDITOR.plugins.list.arrayToList(c, null, d, b, o != n ? n : null), !i.getChildCount() && (CKEDITOR.env.needsNbspFiller && !(7 < h.$.documentMode)) && i.append(h.createText(" ")),
                        ...
                        if (k)
                            for (c = f.getFirst(); c; ) {
                                if (c.type == CKEDITOR.NODE_ELEMENT && (CKEDITOR.dom.element.clearMarkers(k, c), c.getName()in
                                    ...
                                    for (j = e.getParent(); j && !(h = j.getDirection()); )
                                        j = j.getParent();
                ...
                x.prototype = {exec: function (c) {
                        ...
                        if (this.state == CKEDITOR.TRISTATE_OFF) {
                            ...
                            if (j.getFirst(q)) {
                                ...
                                k.enterMode == CKEDITOR.ENTER_BR ? j.appendBogus() : b[0].fixBlock(1, k.enterMode == CKEDITOR.ENTER_P ? "p" : "div"), e.selectRanges(b)
                        }
                            ...
                            if (d = j.shift(), this.state == CKEDITOR.TRISTATE_OFF)
                                if (r[d.root.getName()]) {
                                    ...
                                    for (a = 0; a < f.contents.length; a++)
                                        if (l = f.contents[a], (l = l.getAscendant("li",
            ...
            (function () {
                ...
                function p(a) {
                    ...
                    var c;
                    if (!(c = X(a)))
                        m(a) ? (c = {left: 1, right: 1, center: 1}, c = !(!c[a.getComputedStyle("float")] && !c[a.getAttribute("align")])) : c = !1;
                    return c
                }
                function X(a) {
                ...
                function $(a) {
                    ...
                    if (c.y > e.size.top - 1 && c.y < e.size.top + b)
                        ...
                        return null;
                    if (p(e) || ja(a, e, h) || e.getParent().is(aa))
                        return null;
                    var g = r(a, e, !h);
                    if (g) {
                        if (g && g.type == CKEDITOR.NODE_TEXT)
                            return null;
                        if (m(g)) {
                            if (p(g) || !G(a, g) || g.getParent().is(aa))
                                return null;
                            f = [g, e][h ? "reverse" : "concat"]().concat([O, H])
                        }
                    } else
                        e.equals(a.editable[h ? "getLast" : "getFirst"](a.isRelevant)) ? (C(a), h && c.y > e.size.bottom - b && c.y < d.pane.height && e.size.bottom > d.pane.height - b && e.size.bottom < d.pane.height ? i = y : 0 < c.y && c.y < e.size.top + b &&
                ...
                function P(a, c, d, b) {
                    ...
                    }(), f = c.getDocumentPosition(), i = {}, h = {}, g = {}, j = {}, l = t.length; l--; )
                        i[t[l]] = parseInt(e("border-" + t[l] + "-width"), 10) || 0, g[t[l]] =
                ...
                CKEDITOR.plugins.add("magicline", {init: function (a) {
                        var c = a.config, d = c.magicline_triggerOffset || 30, b = {editor: a, enterMode: c.enterMode, triggerOffset: d, holdDistance: 0 |
                                    d * (c.magicline_holdDistance || 0.5), boxColor: c.magicline_color || "#ff0000", rtl: "rtl" == c.contentsLangDirection, tabuList: ["data-cke-hidden-sel"].concat(c.magicline_tabuList || []), triggers: c.magicline_everywhere ? V : {table: 1, hr: 1, div: 1, ul: 1, ol: 1, dl: 1, form: 1, blockquote: 1}}, e, f, i;
                        ...
                        a.on("contentDom", function () {
                            ...
                            d.is(w.$inline) || (b.inInlineMode && !X(d) && d.setStyles({position: "relative", top: null, left: null}), ha.call(this, b), I(b), d.attachListener(a, "beforeUndoImage", function () {
                                b.line.detach()
                                ...
                                if ("wysiwyg" == a.mode)
                                    if (b.inInlineMode) {
                                        ...
                                        if (!(d > e.left - f.x && d < e.right - f.x) || !(c > e.top - f.y && c < e.bottom - f.y))
                                            clearTimeout(i), i = null, b.line.detach()
                                    } else
                                        clearTimeout(i), i = null, b.line.detach()
                    ...
                    return function (a, c, d) {
                        ...
                        da = function () {
                            function a(a) {
                                ...
                                o(a, f);
                                if (!(a.mouse.y >
                                        e.size.top && a.mouse.y < f.size.bottom))
                                    return null;
                                for (var b = Number.MAX_VALUE, h, g, j, l; f && !f.equals(e) && (g = e.getNext(a.isRelevant)); )
                                    h = Math.abs(ga(a, e, g) - a.mouse.y), h < b && (b = h, j = e, l = g), e = g, o(a, e);
            ...
            CKEDITOR.plugins.add("specialchar", {availableLangs: {ar: 1, bg: 1, ca: 1, cs: 1, cy: 1, de: 1, el: 1, en: 1, eo: 1, es: 1, et: 1, fa: 1, fi: 1, fr: 1, "fr-ca": 1, gl: 1, he: 1, hr: 1, hu: 1, id: 1, it: 1, ja: 1, km: 1, ku: 1, lv: 1, nb: 1, nl: 1, no: 1, pl: 1, pt: 1, "pt-br": 1, ru: 1, si: 1, sk: 1, sl: 1, sq: 1, sv: 1, th: 1, tr: 1, ug: 1, uk: 1, vi: 1, zh: 1, "zh-cn": 1}, requires: "dialog", init: function (a) {
                    var c = this;
            ...
            (function () {
                ...
                var j = "", r = function () {
                    ...
                    var b = this, g = function () {
                        if (!("undefined" != typeof d.instances[b.name] || null != d.instances[b.name])) {
                            ...
                            if (c = d.instances[b.name])
                                e.sLang = c.sLang, e.option(c.option()), e.paused = c.paused;
                    ...
                    b.on("afterCommandExec", function (a) {
                        if (d.isScaytEnabled(b) && "wysiwyg" ==
                                b.mode && ("undo" == a.data.name || "redo" == a.data.name))
                            d.getScayt(b).setDisabled(!0), d.refresh_timeout && window.clearTimeout(d.refresh_timeout), d.refresh_timeout = window.setTimeout(function () {
                ...
                CKEDITOR.plugins.scayt = {engineLoaded: !1, instances: {}, controlInfo: {}, setControlInfo: function (a, c) {
                        ...
                        b[3] = "1";
                        for (var d = 0; 4 > d; d++)
                            c[d] = "undefined" != typeof window.scayt && "undefined" != typeof window.scayt.uiTags ? parseInt(b[d], 10) && window.scayt.uiTags[d] : parseInt(b[d], 10);
                        "object" == typeof a.plugins.wsc ? c.push(1) : c.push(0);
                        return c
                    }, loadEngine: function (a) {
                        if (CKEDITOR.env.gecko && 10900 >
                                CKEDITOR.env.version || CKEDITOR.env.opera || CKEDITOR.env.air)
                ...
                }, u = {preserveState: !0, editorFocus: !1, canUndo: !1, exec: function (a) {
                        if (d.isScaytReady(a)) {
                            ...
                            !a.config.scayt_autoStartup && 0 <= d.engineLoaded && (a.focus(), this.setState(CKEDITOR.TRISTATE_DISABLED), d.loadEngine(a))
                    }};
                CKEDITOR.plugins.add("scayt", {requires: "menubutton,dialog", beforeInit: function (a) {
                        ...
                        1 == c[0] && (b.scaytOptions = {label: h.options, group: "scaytButton", onClick: function () {
                                j = "options";
                                a.openDialog("scaytcheck")
                            }});
                        1 == c[1] && (b.scaytLangs = {label: h.langs, group: "scaytButton", onClick: function () {
                                j =
                                        "langs";
                                a.openDialog("scaytcheck")
                            }});
                        1 == c[2] && (b.scaytDict = {label: h.dictionariesTab, group: "scaytButton", onClick: function () {
                                j = "dictionaries";
                                a.openDialog("scaytcheck")
                            }});
                        ...
                        a.addMenuItems(b);
                        a.ui.add("Scayt", CKEDITOR.UI_MENUBUTTON, {label: h.title, title: CKEDITOR.env.opera ? h.opera_title : h.title, modes: {wysiwyg: this.checkEnvironment()},
                            toolbar: "spellchecker,20", onRender: function () {
                                f.on("state", function () {
                                ...
                                var c = d.getUiTabs(a);
                                return{scaytToggle: CKEDITOR.TRISTATE_OFF, scaytOptions: b && c[0] ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED, scaytLangs: b && c[1] ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED, scaytDict: b && c[2] ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED, scaytAbout: b && c[3] ? CKEDITOR.TRISTATE_OFF :
                        ...
                        a.contextMenu && a.addMenuItems && a.contextMenu.addListener(function (b, c) {
                            ...
                            if (!i || !i.length) {
                                p(a, "no_sugg", h.noSuggestions, "scayt_no_sugg", {exec: function () {
                                ...
                                if (j) {
                                    a.addMenuItem("scayt_moresuggest", {label: h.moreSuggestions, group: "scayt_moresuggest", order: 10, getItems: function () {
                                            return g
                                        }});
                            ...
                            if (o("all", l) || o("ignore", l)) {
                                p(a, "ignore", h.ignore, "scayt_ignore", {exec: function () {
                                        f.ignore(n)
                                    }}, "scayt_control", 2);
                            ...
                            if (o("all", l) || o("ignoreall", l)) {
                                p(a, "ignore_all",
                                        h.ignoreAll, "scayt_ignore_all", {exec: function () {
                                                f.ignoreAll(n)
                                            }}, "scayt_control", 3);
                                e.scayt_ignore_all = CKEDITOR.TRISTATE_OFF
                            }
                            if (o("all", l) || o("add", l)) {
                                p(a, "add_word", h.addWord, "scayt_add_word", {exec: function () {
            ...
            (function () {
                CKEDITOR.plugins.add("stylescombo", {requires: "richcombo", init: function (c) {
                            ...
                            if (b = b.data.styles) {
                                for (var a, h, d = 0, g = b.length; d < g; d++)
                                    if (a = b[d], !(c.blockless && a.element in CKEDITOR.dtd.$block) && (h = a.name, a = new CKEDITOR.style(a), !c.filter.customConfig || c.filter.check(a)))
                                        a._name = h, a._.enterMode = j.enterMode, a._.weight = d + 1E3 * (a.type == CKEDITOR.STYLE_OBJECT ? 1 : a.type == CKEDITOR.STYLE_BLOCK ? 2 : 3), e[h] = a, i.push(a), k.push(a);
                                i.sort(function (a, b) {
                        ...
                        c.ui.addRichCombo("Styles", {label: f.label, title: f.panelTitle, toolbar: "styles,10", allowedContent: k, panel: {css: [CKEDITOR.skin.getPath("editor")].concat(j.contentsCss), multiSelect: !0, attributes: {"aria-label": f.panelTitle}}, init: function () {
                                var b, a, c, d, g, e;
                                g = 0;
                                for (e = i.length; g < e; g++)
                                    b = i[g], a = b._name, d = b.type, d != c && (this.startGroup(f["panelTitle" + d]), c = d), this.add(a, b.type == CKEDITOR.STYLE_OBJECT ? a : b.buildPreview(), a);
                                this.commit()
                            }, onClick: function (b) {
                                c.focus();
                                c.fire("saveSnapshot");
                                ...
                                if (b) {
                                    for (var a in e)
                                        if (e[a].checkApplicable(b, c.activeFilter))
                                            return;
                                    this.setState(CKEDITOR.TRISTATE_DISABLED)
                                }
                            }, reset: function () {
            ...
            (function () {
                ...
                CKEDITOR.plugins.add("undo", {init: function (a) {
                        ...
                        var b = a.undoManager = new g(a), e = a.addCommand("undo", {exec: function () {
                                b.undo() && (a.selectionChange(), this.fire("afterUndo"))
                            }, startDisabled: !0, canUndo: !1}), f = a.addCommand("redo", {exec: function () {
                ...
                g.prototype = {type: function (a, c) {
                    ...
                    resetType: function () {
                        ...
                        if (!this.locked) {
                            ...
                            for (var c = this.index, d = this.snapshots; 0 < c && this.currentImage.equalsContent(d[c - 1]); )
                                c -= 1;
                        ...
                        this.locked ? this.locked.level++ : a ? this.locked = {level: 1} : (a = new f(this.editor, !0), this.locked = {update: this.currentImage &&
