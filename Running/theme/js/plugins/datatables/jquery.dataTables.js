...
(/** @lends <global> */function (window, document, undefined) {
    ...
    (/** @lends <global> */function ($) {
        ...
        function _fnFeatureHtmlFilter(settings)
        {
            ...
            var input = '<input type="search" style="height:27px; margin-right:3px;" class="' + classes.sFilterInput + ' no-print"/>';
            ...
            var filter = $('<div/>', {
                ...
                'class': classes.sFilter + ' no-print'
            })
        ...
        function _fnFeatureHtmlInfo(settings)
        {
            var
                    ...
                    n = $('<div/>', {
                        'class': settings.oClasses.sInfo + ' no-print',
        ...
        function _fnFeatureHtmlLength(settings)
        {
            ...
            var select = $('<select class="no-print" style="height:27px;"/>', {
            ...
            var div = $('<div><label/></div>').addClass(classes.sLength + ' no-print');
        ...
        function _fnFeatureHtmlPaginate(settings)
        {
            var
                    ...
                    node = $('<div/>').addClass(settings.oClasses.sPaging + type + ' no-print')[0],
